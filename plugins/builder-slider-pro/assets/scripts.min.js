...
a.fn.themifyBuilderImagesLoaded||(a.fn.themifyBuilderImagesLoaded=function(b){var a=this.filter("img"),d=a.length;a.bind("load.imgloaded",function(){0>=--d&&"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="!==this.src&&(a.unbind("load.imgloaded"),b.call(a,this))}).each(function(){if(this.complete||void 0===this.complete){var a=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=a}});return this});Themify.body.on("click",".bsp-slide-button",
