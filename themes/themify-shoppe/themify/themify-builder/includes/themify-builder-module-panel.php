	...
	<div class="tb_toolbar_add_modules_wrap" tabindex="-1">
            ...
            <div id="tb_module_panel" class="tb_modules_panel_wrap">
                    ...
                    <ul class="tb_module_types">
						...
						<li><a href="#" data-target="tb_module_panel_library_wrap"><?php _e('Library','themify')?></a></li>
                    </ul>
			...
			<!-- /tb_predesigned_rows_list -->
					...
					<div class="tb_module_panel_tab tb_module_panel_library_wrap">
						<ul class="tb_library_types">
							<li class="active"><a href="#" data-type="row"><?php _e('Rows','themify')?></a></li>
							<li><a href="#" data-type="module"><?php _e('Modules','themify')?></a></li>
							<li><a href="#" data-type="part"><?php _e('Parts','themify')?></a></li>
						</ul>
						<!-- /tb_library_types -->
