...
(b.fn.themifyBuilderImagesLoaded=function(b){var g=this.filter("img"),h=g.length;g.bind("load.imgloaded",function(){0>=--h&&"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="!==this.src&&(g.unbind("load.imgloaded"),b.call(g,this))}).each(function(){if(this.complete||void 0===this.complete){var a=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=a}});return this})})(jQuery);
...
e=e?e[0]:"",c=c.removeAttr("id").removeAttr("class").addClass("nav");c.find("ul").length&&c.find("ul").prev("a").append('<i class="toggle-menu fa fa-angle-down"></i>');Themify.body.addClass("menu-module-"+a);b(".mobile-menu-module").addClass(a+" "+d+" "+e).html(c).prepend('<a class="menu-close"></a>').next(".body-overlay").addClass("body-overlay-on")}).on("click",".mobile-menu-module ul a",function(a){var c=b(this),d=c.find("i.toggle-menu");c.has("i.toggle-menu").length&&(a.preventDefault(),c.next("ul").toggle(),
d.hasClass("fa-angle-down")?d.removeClass("fa-angle-down").addClass("menu-close"):d.removeClass("menu-close").addClass("fa-angle-down"))}).on("click",".mobile-menu-module > .menu-close, .mobile-menu-module + .body-overlay",f)}},GridBreakPoint:function(){function a(){var a=b(h).width(),g="desktop";a<=d?g="mobile":a<=e[1]?g="tablet":a<=c[1]&&(g="tablet_landscape");if(g!==k){var q=(a="desktop"===g)||"desktop"===k;a?Themify.body.removeClass("tb_responsive_mode"):Themify.body.addClass("tb_responsive_mode");
