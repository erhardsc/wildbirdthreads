...
a="string"===typeof a?JSON.parse(a):a;highest_iframe.layoutpart={margin:"",overlay:"",model:function(){if("visual"==b.type){var a=c.Models.Registry.items,d=b.model.get("mod_settings"),g;for(g in a)if("module"==a[g].get("elType")&&"layout-part"==a[g].get("mod_name")&&d.selected_layout_part==a[g].get("mod_settings").selected_layout_part){var e=a[g].get("mod_settings");e.unsetKey=!0;a[g].trigger("custom:preview:refresh",e)}}}};var d=wp.template("builder_layoutpart_lightbox")({link:a.url});a=e("#pagewrap,#wpwrap").append('<div class="themify_builder_overlay_2" style="position: fixed; width: 100%; height: 100%; top: 0; left: 0; bottom: 0; right: 0; z-index: 9990; overflow: hidden;">&nbsp;</div>').children(".themify_builder_overlay_2")[0];
"visual"==c.mode?(a.insertAdjacentHTML("afterend",d),e("#tb_toolbar",highest_iframe).hide(),d=e(".themify_builder_workspace_container",highest_iframe),highest_iframe.layoutpart.margin=d.css("margin"),d.css({margin:"0px"})):a.insertAdjacentHTML("beforebegin",d);e(a).css({backgroundColor:"rgba(0,0,0,0.7)"}).show();highest_iframe.layoutpart.overlay=a}}})}}});c.Views.Columns["default"]=c.Views.BaseElement.extend({tagName:"div",attributes:function(){var a="column"===this.model.get("component_name")?"":
" sub_column",a={"class":"module_column tb-column tb_element_cid_"+this.model.cid+" "+this.model.get("grid_class")+a,"data-cid":this.model.cid};this.model.get("grid_width")&&(a.style="width:"+this.model.get("grid_width")+"%");return a},template:wp.template("builder_column_item"),events:{"click .themify_builder_option_column":"edit","click .js-tb_empty_row_btn":"showModPanel"},initialize:function(){this.listenTo(this.model,"change:view",this.setView)},render:function(a){this.el.innerHTML=this.template({component_name:this.model.get("component_name")});
var b=this.model.get("modules");!c.id&&c.saveCid&&(c.rowStyling[this.model.cid]=1);if(b){var d=document.createDocumentFragment(),g;for(g in b)if(void 0!==b[g]&&null!==b[g]){var f=b[g],e=a?a+"-"+g:!1,k=void 0===f.cols?c.Views.init_module(f,this.type):c.Views.init_subrow(f,this.type);if(k){var l=k.view.render(e);c.id&&f.mod_name?(c.VisualCache[k.model.cid]=f.mod_name+"-"+c.id+"-"+e,l.$el.children(".module")[0].className+=" "+c.VisualCache[k.model.cid]):!c.id&&c.saveCid&&(c.rowStyling[k.model.cid]=1);
d.appendChild(l.el)}}this.el.getElementsByClassName("themify_module_holder")[0].appendChild(d)}return this},edit:function(a){a.preventDefault();a.stopPropagation();this.model.cid!==c.autoSaveCid&&null!==c.autoSaveCid&&c.Forms.saveComponent(null);c.activeModel=this.model;this.editComponent()},setView:function(a){this.setElement(a)},showModPanel:function(a){a.preventDefault();c.toolbar.Panel.show()}});c.Views.SubRows["default"]=c.Views.BaseElement.extend({tagName:"div",attributes:function(){return{"class":"themify_builder_sub_row module_subrow active_module clearfix tb_element_cid_"+
this.model.cid,"data-cid":this.model.cid}},template:wp.template("builder_subrow_item"),events:{"click .themify_builder_style_subrow":"edit"},initialize:function(){this.listenTo(this.model,"change:view",this.setView)},render:function(a){var b=this.model.get("cols"),d=Object.keys(b).length;this.el.innerHTML=this.template();c.id&&(c.VisualCache[this.model.cid]="sub_row_"+a,this.el.className+=" "+c.VisualCache[this.model.cid]);if(0<d){for(var g=document.createDocumentFragment(),f=0;f<=d;++f)if(void 0!==
b[f]){b[f].component_name="sub-column";var e=a+"-"+f,k=c.Views.init_column(b[f],this.type),l=k.view.render("sub_row_"+e).el;c.id&&(c.VisualCache[k.model.cid]="sub_column_post_"+c.id+" sub_column_"+e,l.className+=" "+c.VisualCache[k.model.cid]);g.appendChild(l)}this.el.getElementsByClassName("subrow_inner")[0].appendChild(g)}c.init&&!c.id&&c.Utils.selectedGridMenu(this.el);return this},setView:function(a){this.setElement(a)},edit:function(a){a.stopPropagation();a.preventDefault();this.model.cid!==
c.autoSaveCid&&null!==c.autoSaveCid&&c.Forms.saveComponent(null);c.activeModel=this.model;this.editComponent()}});c.Views.Rows["default"]=c.Views.BaseElement.extend({tagName:"div",attributes:function(){return{"class":"themify_builder_row module_row clearfix tb_element_cid_"+this.model.cid,"data-cid":this.model.cid}},template:wp.template("builder_row_item"),events:{"click .themify_builder_option_row":"edit","click .themify_builder_style_row":"edit","click .tb_visibility_component ":"edit","click .themify_builder_grid_list li a":"_gridMenuClicked",
"click .themify_builder_grid_list_wrapper .grid_tabs li a":"_switchGridTabs","click .themify_builder_column_alignment li a":"_columnAlignmentMenuClicked","click .themify_builder_column_direction li a":"_columnDirectionMenuClicked","change .gutter_select":"_gutterChange","click .toggle_row":"toggleRow","click .themify_builder_toggle_row":"toggleRow"},initialize:function(){this.listenTo(this.model,"change:view",this.setView)},render:function(a){var b=this.model.get("cols"),d=Object.keys(b).length;this.el.innerHTML=
this.template();c.saveCid&&(c.rowStyling[this.model.cid]=1);ThemifyBuilderCommon.inLightboxIframe()&&this.$el.find("a.themify_builder_save_component").remove();if(0<d){for(var g=document.createDocumentFragment(),f,e=!1,k=0;k<=d;++k)if(void 0!==b[k]){b[k].component_name="column";var l=c.Views.init_column(b[k],this.type);c.id&&(f=l.model.get("column_order"),void 0===f&&(f=k),e=a+"-"+f);var m=l.view.render(e).el;c.id&&(c.VisualCache[l.model.cid]="module_column_"+f+" tb_"+c.id+"_column",m.className+=
" "+c.VisualCache[l.model.cid]);g.appendChild(m)}this.el.getElementsByClassName("row_inner")[0].appendChild(g)}else c.Utils._addNewColumn({newclass:"col-full",component:"column",type:this.type},this.$el.find(".row_inner"));c.Utils.selectedGridMenu(this.el);return this},edit:function(a){a.stopPropagation();a.preventDefault();a.currentTarget.classList.contains("themify_builder_style_row")?this.model.set({styleClicked:!0},{silent:!0}):a.currentTarget.classList.contains("tb_visibility_component")&&this.model.set({visibileClicked:!0},
{silent:!0});this.model.cid!==c.autoSaveCid&&null!==c.autoSaveCid&&c.Forms.saveComponent(null);c.activeModel=this.model;this.editComponent()},_switchGridTabs:function(a){c.scrollTo=e(a.currentTarget).closest("[data-cid]");c.Forms.lightbox_switcher(a)},_gridMenuClicked:function(a){a.preventDefault();a=e(a.currentTarget);var b=a.data("grid"),d=a.data("handle"),g=!1,f=a.data("type"),h="desktop"===f,k=ThemifyBuilderCommon.Lightbox.clone(a.closest(".module_row"));a.parent().addClass("selected").siblings().removeClass("selected");
if("module"===d){if("-full"!==b[0]){g=!0;var l=c.Views.init_subrow({cols:[{grid_class:"col-full"}]},c.mode);var m=a.closest(".active_module"),r=m.clone();r.insertAfter(m);var n=l.view.render().$el.find(".themify_module_holder").prepend(m).end().insertAfter(r).find("."+a.attr("class").replace(" ",".")).closest("li").addClass("selected").siblings().removeClass("selected").end().end().end().find(".subrow_inner");r.remove();l=n.closest(".module_subrow")}}else g="subrow"===d,l=a.closest(".module_"+d),
n=l.find("."+d+"_inner").first();if(0!==n.length){if(h||"module"===d){f=n;var w=a.data("col");f=f.add(l);void 0===w&&(w=1,a.data("col",w));f.removeClass("col-count-1 col-count-"+n.attr("data-basecol")).addClass("col-count-"+w);n.attr("data-basecol",w);h&&a.closest(".themify_builder_grid_list_wrapper").find(".themify_builder_grid_reposnive .themify_builder_grid_list").each(function(){var a=e(this).find(".selected"),b=a.find("a"),c=b.data("type"),b=b.data("col");void 0!==b&&(b>w||4===w&&3===b||4<=w&&
4<=b&&w!=b)&&(a.removeClass("selected"),n.removeClass("tb_grid_classes col-count-"+n.attr("data-basecol")+" "+n.attr("data-col_"+c)).attr("data-col_"+c,""),e(this).closest(".themify_builder_grid_list").find("."+c+"-auto").parent().addClass("selected"))})}else return"-auto"!==b[0]?(k="column"+b.join("-"),w=a.data("col"),3===w&&n.attr("data-basecol")>w&&(k+=" tb_3col"),n.removeClass(n.attr("data-col_tablet")+" "+n.attr("data-col_tablet_landscape")+" "+n.attr("data-col_mobile")).addClass(k+" tb_grid_classes col-count-"+
n.attr("data-basecol")).attr("data-col_"+f,k)):n.removeClass("tb_grid_classes tb_3col col-count-"+n.attr("data-basecol")+" "+n.attr("data-col_"+f)).attr("data-col_"+f,""),"visual"===c.mode&&e("body",top_iframe).height(document.body.scrollHeight),c.Utils.setCompactMode(n.children(".module_column")),!1;f=n.children(".module_column");h=b.length;d="module_column"+(g?" sub_column":"")+" col";for(l=0;l<h;++l)m=f.eq(l),0<m.length?m.removeClass(c.Utils.gridClass.join(" ")).addClass(d+b[l]):c.Utils._addNewColumn({newclass:d+
b[l],component:g?"sub-column":"column",type:c.mode},n);h<n.children().length&&n.children(".module_column").eq(h-1).nextAll().each(function(){e(this).find(".themify_module_holder").first().children().appendTo(e(this).prev().find(".themify_module_holder").first());e(this).remove()});f=n.children();f.removeClass("first last");n.hasClass("direction-rtl")?(f.last().addClass("first"),f.first().addClass("last")):(f.first().addClass("first"),f.last().addClass("last"));g&&"-full"===b[0]&&(b=n.closest(".module_subrow"),
b.closest(".module_column"),g=n.find(".active_module"),g.insertAfter(b),b.remove(),g.find(".themify_builder_grid_list .grid-layout--full").parent().addClass("selected").siblings().removeClass("selected"));c.Utils.columnDrag(n,!0);l=a.closest(".module_row");c.Mixins.Builder.columnSort(l);c.Mixins.Builder.updateModuleSort(l);c.vent.trigger("dom:change",l.data("cid"),k,l,"row")}},_columnAlignmentMenuClicked:function(a){a.preventDefault();a=e(a.currentTarget);var b=a.data("handle");if("module"!==b&&!a.closest("li").hasClass("selected")){a.closest("li").addClass("selected").siblings("li").removeClass("selected");
var d=a.closest(".module_"+b);var g=a.data("alignment"),f=c.Models.Registry.lookup(d.data("cid")),h=ThemifyBuilderCommon.Lightbox.clone(d);d.find("."+b+"_inner").first().removeClass(f.get("column_alignment")).addClass(g);f.set({column_alignment:g},{silent:!0});c.vent.trigger("dom:change",h.data("cid"),h,a.closest(".module_"+b),"row")}},_columnDirectionMenuClicked:function(a){a.preventDefault();var b=e(a.currentTarget),d=b.data("handle");a=b.data("dir");if("module"!==d&&!b.closest("li").hasClass("selected")){b.closest("li").addClass("selected").siblings("li").removeClass("selected");
var b=b.closest(".module_"+d),d=b.find("."+d+"_inner").first(),g=d.children(".module_column"),b=g.first(),g=g.last();"rtl"===a?(b.removeClass("first").addClass("last"),g.removeClass("last").addClass("first"),d.addClass("direction-rtl")):(b.removeClass("last").addClass("first"),g.removeClass("first").addClass("last"),d.removeClass("direction-rtl"));d.attr("data-"+c.activeBreakPoint+"_dir",a)}},_gutterChange:function(a){a=e(a.currentTarget);var b=a.data("handle");if("module"!==b){var d=a.val();a.find("option").removeAttr("selected").filter('[value="'+
d+'"]').attr("selected","selected");var g=a.closest(".module_"+b),f=ThemifyBuilderCommon.Lightbox.clone(g),h=g.find("."+b+"_inner").first(),k=c.Models.Registry.lookup(g.data("cid"));f.find(".themify_builder_"+b+"_top .gutter_select").val(g.data("gutter"));c.Utils.columnDrag(h,!1,k.get("gutter"),d);h.removeClass(k.get("gutter")).addClass(d);k.set({gutter:d},{silent:!0});c.vent.trigger("dom:change",f.data("cid"),f,a.closest(".module_"+b),"row")}},setView:function(a){this.setElement(a)},toggleRow:function(a){a.preventDefault();
a.stopPropagation();var b=e(a.currentTarget).closest(".module_row");b.find(".row_inner").first().slideToggle("fast",function(){b.toggleClass("collapsed")})}});c.Views.Builder=Backbone.View.extend({type:"default",events:{"click .tb-import-layout-button":"importLayoutButton"},initialize:function(a){_.extend(this,_.pick(a,"type"));c.vent.on("dom:builder:change",this.tempEvents.bind(this));c.vent.on("dom:builder:init",this.init.bind(this))},init:function(a){c.Forms.getFormTemplates();c.init=a;this.rowSort();
"visual"===c.mode?(this.updateModuleSort(this.$el),a&&this.initModuleVisualDrag(),setTimeout(function(){c.Utils._onResize(!0)},1500)):(a&&this.initModuleDraggable(c.toolbar.$el),this.updateModuleSort(e("body")));var b=this;setTimeout(function(){c.Utils.setCompactMode(b.el.getElementsByClassName("module_column"))},1E3);c.vent.trigger("dom:builder:change");this.insertLayoutButton();c.init=!0},render:function(){for(var a=document.createDocumentFragment(),b=this.collection,d=!1,g=0,f=b.length;g<f;++g){var e=
c.Views.init_row(b.models[g],this.type);if(!1!==e){c.id&&(d=e.model.get("row_order"),void 0===d&&(d=g));var k=e.view.render(d).el;c.id&&(c.VisualCache[e.model.cid]="themify_builder_"+c.id+"_row module_row_"+d,k.className+=" "+c.VisualCache[e.model.cid]);a.appendChild(k)}}this.el.appendChild(a);c.Utils.columnDrag(!1,!1);return this},tempEvents:function(){this.newRowAvailable()},insertLayoutButton:function(){this.$el.find(".tb-import-layout-button").remove();2>this.$(".module_row").length&&this.el.insertAdjacentHTML("beforeend",
'<a href="#" class="tb-import-layout-button'+(themifyBuilder.is_premium?"":" themify_builder_lite")+'">'+themifyBuilder.i18n.text_import_layout_button+"</a>")},importLayoutButton:function(a){a.preventDefault();c.Views.Toolbar.prototype.loadLayout(a)}});c.Mixins.Common={styleData:{},doTheBinding:function(a,b,d){var g=!1,f=!1,h=a.data("binding"),k="desktop"!==c.activeBreakPoint;b||void 0===h.empty?b&&void 0!==h[b]?g="radio"===a.attr("type")?a.is(":checked")?h[b]:!1:h[b]:b&&void 0!==h.not_empty?g=h.not_empty:
void 0!==h.select&&b!==h.select.value?g=h.select:void 0!==h.checked&&a.is(":checked")?g=h.checked:void 0===h.not_checked||a.is(":checked")||(g=h.not_checked):g=h.empty;void 0!==h.responsive&&a.is("select")&&(f=h.responsive,k&&void 0!==f.disabled&&void 0!==this.styleData.breakpoint_desktop[a.prop("id")]&&_.contains(f.disabled,this.styleData.breakpoint_desktop[a.prop("id")])&&(g=h[this.styleData.breakpoint_desktop[a.prop("id")]]));if(g){h=[];void 0!==g.show&&(h=g.show);void 0!==g.hide&&(h=h.concat(g.hide));
if(void 0===d||0===d.length)d=e("#themify_builder_lightbox_container",top_iframe);b=0;for(h=h.length;b<h;++b)void 0!==g.hide&&void 0!==g.hide[b]&&e("."+g.hide[b],d).addClass("_tf-hide").hide(),void 0!==g.show&&void 0!==g.show[b]&&e("."+g.show[b],d).removeClass("_tf-hide").show();if(void 0!==g.responsive)for(h=[],void 0!==g.responsive.disabled&&(h=h.concat(g.responsive.disabled)),b=0,h=h.length;b<h;++b)void 0!==g.responsive.disabled&&void 0!==g.responsive.disabled[b]&&(k?e("."+g.responsive.disabled[b],
d).addClass("reponive_disable"):e("."+g.responsive.disabled[b],d).removeClass("reponive_disable"))}if(f)for(d=[],void 0!==f.disabled&&(d=d.concat(f.disabled)),b=0,h=d.length;b<h;++b)void 0!==f.disabled&&void 0!==f.disabled[b]&&a.find('option[value="'+f.disabled[b]+'"]').prop("disabled",k)},moduleOptionsBinding:function(){var a=this;e("#themify_builder_lightbox_container",top_iframe).on("change","[data-binding]",function(){a.doTheBinding(e(this),e.trim(e(this).val()),e(this).closest(".tb_repeatable_field_content"))}).on("click",
".themify-layout-icon[data-binding] a",function(){a.doTheBinding(e(this).parent(),e(this).prop("id"),e(this).closest(".tb_repeatable_field_content"))})},mode_change:function(a){function b(a){null===h&&(h=ThemifyBuilderCommon.Lightbox.$lightbox.find("#themify_builder_options_styling")[0]);f.styleData["breakpoint_"+a]=c.Forms.serialize("themify_builder_options_styling",f.styleData,a,!1)}function d(c,d,g){b(d);f.editComponentCallback(h,a,f.styleData,!0)}var g="module"===a&&void 0!==c.activeModel.get("is_new")?
e(".tb_element_cid_"+c.activeModel.cid).closest(".module_row"):e(".tb_element_cid_"+c.activeModel.cid);c.beforeEvent=ThemifyBuilderCommon.Lightbox.clone(g);var f=this,h=null;f.styleData={};f.styleData.breakpoint_desktop=e.extend(!0,{},c.activeModel.get("module"===a?"mod_settings":"styling"));for(var k in themifyBuilder.breakpoints)void 0!==f.styleData.breakpoint_desktop["breakpoint_"+k]&&(f.styleData["breakpoint_"+k]=f.styleData.breakpoint_desktop["breakpoint_"+k],delete f.styleData.breakpoint_desktop["breakpoint_"+
k]);e("body").off("themify_builder_change_mode",d).on("themify_builder_change_mode",d).one("themify_builder_lightbox_before_close",function(){z=[];c.saving&&b(c.activeBreakPoint);e("body").off("themify_builder_change_mode",d)})},editComponentCallback:function(a,b,d,g){var f="styling",h=c.Mixins.Common,k=b,l=[],m=[],r=[],n=[],w=[],t=[],p=!1,x="desktop"!==c.activeBreakPoint?Object.keys(themifyBuilder.breakpoints).reverse():!1;"module"===b&&(k=c.activeModel.get("mod_name"),f="mod_settings",p=void 0!==
c.activeModel.get("is_new"));if(!1!==x){for(var u=x.indexOf(c.activeBreakPoint),q=0;q<=u;++q)x.shift();x.push("desktop")}var D=function(a,b,d,f){var q="";f?q=a.getAttribute("data-input-id"):(q=a.getAttribute("name"))||(q=a.getAttribute("id"));var v=b&&void 0!==b[q]?b[q]:!1;if(g||"px"!==v&&"pixels"!==v&&"solid"!==v&&"|"!==v&&"default"!==v){var y=e(a),u=a.classList;if(!p&&!1!==x&&!f&&!v)if(u.contains("themify-checkbox"))void 0!==d[q]&&0===y.closest("#themify_builder_options_styling").length&&(v=d[q]);
else{f=0;for(var E=x.length;f<E;++f)if(void 0!==d["breakpoint_"+x[f]]&&void 0!==d["breakpoint_"+x[f]][q]){v=d["breakpoint_"+x[f]][q];break}else if("desktop"===x[f]&&void 0!==d[q]){v=d[q];break}}if(u.contains("themify-gradient"))n.push({k:y,v:v}),v&&y.val(v);else if(u.contains("themify-builder-uploader-input"))v?(d=e("<img/>",{src:v,width:50,height:50}),y.val(v).parent().find(".img-placeholder").html(d)):g&&y.val("").parent().find(".img-placeholder").empty();else if(u.contains("themify-option-query-cat"))v&&
(d=y.parent(),f=v.split("|")[0],d.find("#"+q+"_dropdown").children("option[value='"+f+"']").prop("selected",!0),d.find(".query_category_multiple").val(f));else if(u.contains("tb-radio-input-container"))d=null,f=v?v:void 0!==y.data("default")?y.data("default"):!1,!1!==f&&""!==f?(d=y.find("input[value='"+f+"']"),d.is(":disabled")?d=null:d.prop("checked",!0)):g&&u.contains("tb-icon-radio")&&y.find("input").prop("checked",!1),null===d&&(d=y.find("input:checked")),0<d.length&&u.contains("tb-option-radio-enable")&&
m.push(d);else if(u.contains("themify-checkbox")){d=y.find(".tb-checkbox");!v&&_.isEmpty(b)&&(v=d.map(function(){return e(this).is(":checked")?e(this).val():null}).get().join("|"));if(v){var F=v.split("|");d.each(function(){-1!==F.indexOf(e(this).val())&&e(this).prop("checked",!0)})}else if(!p||g)if(f=d.closest(".themify_builder_input").find(".tb_seperate_items input"),f.length){var z=!1;f.each(function(){if(e(this).val().length)return z=!0,!1});d.prop("checked",!z)}else d.prop("checked",!1);u.contains("tb-option-checkbox-enable")&&
r.push(d)}else if(u.contains("themify-layout-icon"))v?y.find("a").filter(function(){e(this).removeClass("selected");if(v===e(this).prop("id"))return e(this)}).addClass("selected"):(d=themifyBuilder.modules[k],void 0!==d&&void 0!==d.defaults&&d.defaults[q]?y.find("#"+d.defaults[q]).addClass("selected"):y.find("a").first().addClass("selected"));else if("SELECT"===a.tagName)v?(y.val(v),u.contains("font-family-select")&&y.data("selected",v)):g&&y.find("option").prop("selected",!1),g&&u.contains("font-family-select")&&
(-1===y.prop("tabindex")?y.trigger("change.select"):v&&(d=y.find("optgroup"),void 0!==ThemifyBuilderCommon.safe_fonts[v]?d.first().html('<option selected="selected" data-type="webfont" value="'+v+'">'+ThemifyBuilderCommon.safe_fonts[v]+"</option>"):d.last().html('<option selected="selected" value="'+v+'">'+ThemifyBuilderCommon.google_fonts[v]+"</option>")));else if("TEXTAREA"===a.tagName||"INPUT"===a.tagName){d="TEXTAREA"===a.tagName;if(v||g)g&&!v&&(v=""),y.val(v),u.contains("minicolors-input")?(f=
v,q="",-1!==v.indexOf("_")?(f=c.Utils.toRGBA(v),v=v.split("_"),(q=v[1])||(q=1),y.val(v[0])):v&&(-1===v.indexOf("#")&&(f="#"+v),q=1),y.attr("data-opacity",q).next(".minicolors-swatch").find("span").css({background:f,opacity:q}).closest(".minicolors").next(".color_opacity").val(q)):d&&!p&&(u.contains("tb-shortcode-input")||u.contains("tb-thumbs-preview"))&&h.getShortcodePreview(y,v);d&&u.contains("tb_lb_wp_editor")&&l.push(y)}else if(u.contains("themify_builder_row_js_wrapper")){var E=v?v.length-1:
0,B=e.Event("click",{isTrigger:!0,currentTarget:y.next(".add_new").find("a").first()});void 0===c.cache.repeaterElements[q]&&(b=a.getElementsByClassName("tb_repeatable_field"),c.cache.repeaterElements[q]=e(b[0]).clone());for(f=0;f<E;++f)c.Forms.moduleOptAddRow(B,null);b=a.getElementsByClassName("tb_repeatable_field");f=0;for(q=b.length;f<q;++f){a=b[f].getElementsByClassName("tb_lb_option_child");for(var E=void 0!==v[f]?v[f]:!1,B=0,A=a.length;B<A;++B)D(a[B],E,d,!0)}w.push({el:y,binding_type:y.data("control-binding")})}y.data("binding")?
t.push({el:y,v:v}):y.find(".tb-checkbox").data("binding")&&t.push({el:y.find(".tb-checkbox"),v:v});g||!y.data("control-binding")||u.contains("tb_lb_wp_editor")||u.contains("minicolors-input")||u.contains("themify-gradient")||"repeater"===y.data("control-type")||c.Views.init_control(y.data("control-type"),{el:y,binding_type:y.data("control-binding"),selector:y.data("live-selector")})}};d=g?d:c.activeModel.get(f);var B=e.extend(!0,{},d);if("desktop"!==c.activeBreakPoint||g)if(void 0!==B["breakpoint_"+
c.activeBreakPoint])B=B["breakpoint_"+c.activeBreakPoint];else for(q=0,f=x.length;q<f;++q)if(void 0!==B["breakpoint_"+x[q]]){B=B["breakpoint_"+x[q]];break}f=a.getElementsByClassName("tb_lb_option");q=0;for(u=f.length;q<u;++q)D(f[q],B,d,!1),g||f[q].addEventListener("change",function F(a){a.currentTarget.removeEventListener(a.type,F);c.hasChanged=!0},{once:!0},!1);f=null;e(".themify_builder_font_preview_wrapper",a).each(function(){e(this).one("focusin",function(){c.hasChanged=!0})});g||(0<w.length&&
setTimeout(function(){for(var a=0,b=w.length;a<b;++a)c.Views.init_control("repeater",w[a]);w=null},1),setTimeout(function(){if("module"===b)for(var a=0,c=t.length;a<c;++a)h.doTheBinding(t[a].el,t[a].v);t=null;h.moduleOptionsBinding()},1));setTimeout(function(){for(var a=0,b=m.length;a<b;++a)ThemifyBuilderCommon.Lightbox.clickRadioOption(null,m[a]);m=null},1);setTimeout(function(){for(var a=0,b=r.length;a<b;++a)ThemifyBuilderCommon.Lightbox.clickCheckboxOption(null,r[a]);r=null},1);setTimeout(function(){h.applyAll_init(g);
for(var b=a.getElementsByClassName("border_style"),c=0,d=b.length;c<d;++c)ThemifyBuilderCommon.Lightbox.hideShowBorder(null,e(b[c]))},1);void 0!==e.fn.ThemifyGradient&&setTimeout(function(){for(var a=0,b=n.length;a<b;++a)c.Utils.createGradientPicker(n[a].k,n[a].v,g);n=null},1);g||(setTimeout(function(){ThemifyBuilderCommon.fontPreview(e("#themify_builder_lightbox_container",top_iframe))},300),p&&"gallery"===k&&setTimeout(function(){e(".tb-gallery-btn",a).trigger("click")},1),setTimeout(function(){c.Utils.builderPlupload("normal")},
1),setTimeout(function(){c.Utils.setColorPicker(a)},1),"visual"===c.mode&&(setTimeout(function(){z="module"===b?c.Forms.serialize("themify_builder_options_setting"):B;c.liveStylingInstance.init(z)},1),p||ThemifyBuilderCommon.Lightbox.rememberRow()),setTimeout(function(){if(0<l.length){var a=function(){for(var a=0,b=l.length;a<b;++a)c.Views.init_control("wp_editor",{el:l[a],binding_type:l[a].data("control-binding"),selector:l[a].data("live-selector")});l=null};if(c.activeModel.get("styleClicked")||
c.activeModel.get("visibileClicked"))e("body").one("themify_builder_tabsactive",function(b,c,d){"#themify_builder_options_setting"===c&&a()});else a()}h.mode_change(b)},1),e("body").trigger("editing_"+b+"_option",[k,B,a]),"visual"===c.mode&&window.parent.jQuery("body").trigger("editing_"+b+"_option",[k,B,a]))},applyAll_init:function(a){var b=e(".style_apply_all",top_iframe);b.off("change.tb_apply_all").on("change.tb_apply_all",function(a){var b=e(this).closest(".themify_builder_input").find(".tb_seperate_items"),
c=b.find("li");a=!a.isTrigger;e(this).is(":checked")?(a?c.not(":first-child").slideUp():c.not(":first-child").hide(),b.attr("data-checked",1)):(c.slideDown(),b.removeAttr("data-checked"));a&&c.first().find("select").trigger("change")});a||(b=b.filter(":checked"));b.trigger("change.tb_apply_all")},getShortcodePreview:function(a,b){function c(b){a.next(".tb_shortcode_preview").remove();b&&a.after(b)}var g=this;void 0===g.galerry_cache&&(g.galerry_cache={});void 0!==g.galerry_cache[b]?c(g.galerry_cache[b]):
e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_load_shortcode_preview",tb_load_nonce:themifyBuilder.tb_load_nonce,shortcode:b},success:function(a){c(a);g.galerry_cache[b]=a}})}};c.Mixins.Builder={rowSortable:{},rowSort:function(){var a=!1,b=this,d,g,f;this.rowSortable={items:".module_row",handle:".themify_builder_row_top",axis:"y",placeholder:"themify_builder_ui_state_highlight",containment:"parent",tolerance:"pointer",forceHelperSize:!0,forcePlaceholderSize:!0,scroll:!1,beforeStart:function(d,
f){b.dragScroll();"visual"!==c.mode||f.item.hasClass("collapsed")||(a=!0,f.item.addClass("collapsed ui-sortable-row"))},start:function(a,b){d=b.placeholder.index();f=b.item.outerHeight(!0);b.item.nextAll(".module_row").css("transform","translateY("+f+"px)")},change:function(a,b){g=b.placeholder.index();var c=!1;d>g?(c=e(".module_row"),c=c.slice(g,c.length)):d<g&&(c=e(".module_row").slice(d,g),f=0);!1!==c&&c.not(".ui-sortable-helper").each(function(){e(this).css("transform","translateY("+f+"px)")});
d=g},stop:function(c,d){a&&(d.item.removeClass("collapsed ui-sortable-row"),a=!1);e(".ui-sortable-handle, .module_row").css("transform","");b.dragScroll(!0)},update:function(a,d){d.item.hasClass("predesigned_row")&&e(document).trigger("tb_setpredesignedrows",[d.item.data("slug"),function(a){b.rowDrop(a,d.item)}]);d.item.hasClass("tb_row_grid")&&e(document).trigger("tb_setpremaderows",[d.item.data("slug"),function(a){b.rowDrop(a,d.item)}]);if("library_item"==d.item.data("type")){var f=c.toolbar.libraryItems.get(d.item.data("main"),
d.item.data("id"));f.raw&&(Array.isArray(f.raw)?b.rowDrop(f.raw,d.item):b.rowDrop(Array(f.raw),d.item))}}};"visual"===c.mode&&(this.rowSortable.helper=function(){return e('<div class="themify_builder_sortable_helper"/>')});this.$el.sortable(this.rowSortable);this.columnSort(this.$el)},columnSort:function(a){var b,d=e("body"),g;a.find(".row_inner, .subrow_inner").sortable({items:"> .module_column",handle:"> .themify_builder_column_action .themify_builder_column_dragger",axis:"x",placeholder:"themify_builder_ui_state_highlight",
tolerance:"pointer",cursorAt:{top:20,left:20},beforeStart:function(a,c){d.addClass("themify_builder_drag_start");b=ThemifyBuilderCommon.Lightbox.clone(c.item.closest(".module_row"));g=c.item.siblings();g.css("marginLeft",0)},start:function(a,b){e(".themify_builder_ui_state_highlight").width(b.item.width())},stop:function(a,b){d.removeClass("themify_builder_drag_start");g.css("marginLeft","")},update:function(a,d){var f=d.item.closest(".ui-sortable"),g=f.children(".module_column");g.removeClass("first last");
f.hasClass("direction-rtl")?(g.last().addClass("first"),g.first().addClass("last")):(g.first().addClass("first"),g.last().addClass("last"));c.Utils.columnDrag(f,!1);c.Utils.setCompactMode(g);f=f.closest(".module_row");c.vent.trigger("dom:change",f.data("cid"),b,f,"row")}})},update:function(a){var b=null!==c.activeModel?c.activeModel.get("elType"):c.Models.Registry.lookup(a.data("cid")).get("elType");"visual"===c.mode&&c.Utils.loadContentJs(a,b);c.Mixins.Builder.columnSort(a);a=a.closest(".module_row");
c.Utils.columnDrag(a.find(".row_inner"),!1);c.Utils.columnDrag(a.find(".subrow_inner"),!1);this.updateModuleSort(a)},dragScroll:function(a){var b=e("body",top_iframe);"visual"===c.mode&&(b=b.add(e("body")));void 0===this.top&&(this.top=c.toolbar.$el,this.top=this.top.add(e("#themify_builder_fixed_bottom_scroll",top_iframe)),"visual"!==c.mode&&(this.top=this.top.add("#wpadminbar")));if(!0===a)this.top.off("mouseenter"),b.removeClass("themify_builder_drag_start");else{var d="desktop"===c.activeBreakPoint?
e("body,html"):e("body,html",top_iframe),g="",f=0;"visual"===c.mode?(g=d.height(),f=e(window.parent).height()):g=e("#page-builder").height();b.addClass("themify_builder_drag_start");this.top.off("mouseenter").on("mouseenter",function(a){a=parseInt((g-f)/7);if(0<a){var b=e(this).prop("id");a=("tb_toolbar"===b||"wpadminbar"===b?"-":"+")+("="+a+"px");d.stop().animate({scrollTop:a},800)}else d.stop()})}},updateModuleSort:function(a,b){var d=b?e(".themify_module_holder"):a.find(".themify_module_holder");
if(b)return d.sortable(b),!1;d.each(function(){e(this).data().uiSortable=null});var g=!1,f=!1,h=this,k={placeholder:"themify_builder_ui_state_highlight",items:".active_module",connectWith:".themify_module_holder",revert:100,scroll:!1,tolerance:"pointer",cursorAt:{top:20,left:110},beforeStart:function(a,b){!1===f&&(f=ThemifyBuilderCommon.Lightbox.clone(b.item.closest(".module_row")),"visual"===c.mode&&(b.item.css("height",40),g=!0),h.dragScroll())},stop:function(a,b){h.dragScroll(!0);if("dragstop"!==
a.type){g&&(b.item.css("height",""),g=!1);var d=b.item.closest(".module_row");c.vent.trigger("dom:change",b.item.data("cid"),f,d,"sort",{before:f.data("cid"),after:d.data("cid")})}f=!1},update:function(a,b){b.sender?(b.item.hasClass("module_subrow")&&0<b.item.parents(".module_subrow").length&&(b.item.find(".active_module").clone().insertAfter(b.item),b.item.remove()),c.vent.trigger("dom:builder:change")):b.item.hasClass("tb_module_dragging_helper")&&(z=[],h.moduleDrop(b.item,!1))}};"visual"===c.mode&&
(k.helper=function(){return e('<div class="themify_builder_sortable_helper"/>')},k.handle=".themify_builder_module_front_overlay, .themify_builder_subrow_top");d.sortable(k)},initModuleDraggable:function(a){var b=this;a.find(".themify_builder_module, .dragable_library_item_module, .dragable_library_item_part").draggable({appendTo:"body",helper:"clone",revert:"invalid",scroll:!1,connectToSortable:".themify_module_holder",containment:"#themify_builder_row_wrapper,.themify_builder_content",cursorAt:{top:10,
...
b.prev().hasClass("themify_module_holder")?b.parent().find("> .themify_module_holder").append(d.view.render().$el):b.parent().find("> .themify_module_holder").prepend(d.view.render().$el);for(var g=a[0].cols.length,f,e=0;e<g;++e)f="",0===e&&(f="first "),e===g-1&&(f="last "),c.Utils._addNewColumn({newclass:f+a[0].cols[e].grid_class,component:"sub-column",type:c.mode},d.view.$el.find(".subrow_inner"));c.Mixins.Builder.updateModuleSort(d.view.$el);c.Utils.setCompactMode(d.view.el.getElementsByClassName("module_column"))}b.remove()},
rowDrop:function(a,b){function d(){var a=b.prev(".module_row"),d=b.closest(".themify_builder_content").data("postid"),a=0===a.length?!1:a.data("cid");b[0].innerHTML="";b[0].parentNode.replaceChild(g,b[0]);c.saveCid=!1;c.rowStyling=[];c.vent.trigger("dom:change","","","","predesign",{prev:a,rows:f,bid:d});a=0;for(d=f.length;a<d;++a)c.Mixins.Builder.update(f[a]);ThemifyBuilderCommon.showLoader("hide")}var g=document.createDocumentFragment(),f=[];c.saveCid=!0;for(var e in a)if(a[e].cols&&(0<Object.keys(a[e].cols).length||
a[e].cols[0].styling&&0<Object.keys(a[e].cols[0].styling).length)||a[e].styling&&0<Object.keys(a[e].styling).length){var k=c.Views.init_row(a[e],c.mode);!1!==k&&(k=k.view.render(),g.appendChild(k.el),f.push(k.$el))}"visual"===c.mode?c.bootstrap(c.rowStyling,d):d()},moduleDrop:function(a,b){function d(d){m.model.set({is_new:1},{silent:!0});d=!0===d?m.model.getPreviewSettings():m.model.get("mod_settings");b?b.append(r.el):(a.replaceWith(r.el),c.Mixins.Builder.update(r.$el));k?c.activeModel=m.model:
m.view.trigger("edit",null);c.hasChanged=!0;if("visual"===c.mode&&1<Object.keys(d).length)if("ajax"===a.data("type")||"ajax"===themifyBuilder.modules[m.model.get("mod_name")].type||"parts"===n){var f=!0;m.model.trigger("custom:preview:refresh",d)}else m.model.trigger("custom:preview:live",d);if(k){if(f){var e=m.view.$el.find(".tb-preview-component").detach();setTimeout(function(){m.view.$el.prepend(e)},50)}g=m.view.$el.closest(".module_row");c.vent.trigger("dom:change",g.data("cid"),l,g,"row")}}var g,
f=this;if(a.hasClass("tb_row_grid"))e(document).trigger("tb_setpremaderows",[a.data("slug"),function(b){f.subRowDrop(b,a)}]);else{var h={mod_name:a.data("module-slug")},k=!1;if("library_item"===a.data("type")){k=!0;h=c.toolbar.libraryItems.get(a.data("main"),a.data("id")).raw;var l=ThemifyBuilderCommon.Lightbox.clone(a.closest(".module_row"))}else c.toolbar.Panel.hide();var m=c.Views.init_module(h,c.mode),r=m.view.render(),n=a.data("main");"visual"===c.mode&&"library_item"===a.data("type")?(h=[],
h[m.model.cid]=1,c.bootstrap(h,d)):d(!0)}},newRowAvailable:function(){var a=this.$el.children(".module_row");if(0===a.length||0<a.last().find(".active_module").length)a=c.Views.init_row({cols:[{grid_class:"col-full"}]},this.type).view.render().$el,a.appendTo(this.$el),e("#sortable").data("sortable")?this.$el.sortable(this.$el.sortable("option")):this.$el.sortable(this.rowSortable),c.Mixins.Builder.updateModuleSort(a),"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&e("body",top_iframe).height(document.body.scrollHeight)},
toJSON:function(){for(var a={},b=this.el.getElementsByClassName("module_row"),d=0,g=b.length;d<g;++d)a[d]=c.Utils._getRowSettings(b[d],d);return a}};c.Forms={Data:{},Validators:{},bindEvents:function(){e("body",top_iframe).on("true"===themifyBuilder.isTouch?"touchend":"click",".builder_save_button",this.saveComponent).on("click","#themify_builder_lightbox_parent .add_new a",this.moduleOptAddRow).on("click","#builder_submit_import_form",this.builderImportSubmit).on("click",".tb-lightbox-switcher a",
this.lightbox_switcher).on("click",".layout_preview img",this.templateSelected).on("click","#builder_submit_layout_form",this.saveAsLayout).on("click","#builder_submit_library_item_form",this.saveAsLibraryItem).on("keypress","#tb_library_item_form input",this.saveAsLibraryItem);e("body").on("themify_builder_lightbox_close",this.clear);this.widget_actions()},getFormTemplates:function(){function a(a){var b="";if("string"===typeof a)b=a;else for(var c in a)b+=a[c];document.getElementsByTagName("body")[0].insertAdjacentHTML("beforeend",
b)}var b=function(){if(themifyBuilder.debug)return!1;try{var a=localStorage.getItem("tb_form_templates"),b="";if(!a)return!1;var a=JSON.parse(a),c;for(c in themifyBuilder.modules)b+=c;return a.ver.toString()!==tbLocalScript.version.toString()||a.h!==Themify.hash(b)?!1:a.val}catch(h){}return!1}();b?a(b):e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_load_form_templates",tb_load_nonce:themifyBuilder.tb_load_nonce},success:function(b){if(b){a(b);b=b.replace(/\s\s+/g," ");try{var c="",
d;for(d in themifyBuilder.modules)c+=d;var e={val:b,ver:tbLocalScript.version,h:Themify.hash(c)};localStorage.setItem("tb_form_templates",JSON.stringify(e))}catch(k){}}}})},parseSettings:function(a,b,c,g){var d=!1,h=e(a),k=a.classList,l="",m=!0;g?l=h.data("input-id"):(l=a.getAttribute("name"))||(l=a.getAttribute("id"));if(k.contains("tb_lb_wp_editor"))void 0!==tinyMCE?(d=a.getAttribute("id"),a=tinyMCE.get(d),d=null!==a?!1===a.hidden?a.getContent():switchEditors.wpautop(tinymce.DOM.get(d).value):h.val()):
...
g=0,k=a.length;g<k;++g){var n=a[g].getElementsByClassName("tb_lb_option_child");d[g]={};for(var w=0,t=n.length;w<t;++w){var p=this.parseSettings(n[w],b,c,!0);p&&"px"!==p.v&&"pixels"!==p.v&&"solid"!==p.v&&"default"!==p.v&&"|"!==p.v&&(d[g][p.id]=p.v)}}else k.contains("tb-radio-input-container")?(m=h.find("input:checked"),"desktop"!==c&&m.hasClass("reponive_disable")||(d=m.val()),m=!1):k.contains("module-widget-form-container")?d=h.find(":input").themifySerializeObject():(d=h.val(),a=h.attr("data-opacity"),
void 0!==a&&""!==a&&1!=a&&"0.99"!==a&&(d+="_"+a));if(d||!b)if(!b||b&&"px"!==d&&"pixels"!==d&&"solid"!==d&&"linear"!==d&&"default"!==d&&"|"!==d&&("desktop"===c||0===h.closest(".reponive_disable").length))return b||!1!==d||(d=""),{id:l,v:d,checked:m};return!1},serialize:function(a,b,d){d=d||c.activeBreakPoint;var g=void 0!==b;void 0===this.breakpoints&&"desktop"!==d&&g&&(this.breakpoints=Object.keys(themifyBuilder.breakpoints).reverse());var e={};a=top_iframe.getElementById(a).getElementsByClassName("tb_lb_option");
var h="desktop"!==d&&g&&void 0!==this.breakpoints?this.breakpoints:!1;if(!1!==h){for(var k=h.indexOf(d),l=0;l<=k;++l)h.shift();h.push("desktop")}l=0;for(k=a.length;l<k;++l){var m=this.parseSettings(a[l],g,d,!1);if(!1!==m){if(!1!==h&&!0===m.checked&&"SELECT"!==a[l].tagName){for(var r=!1,n=0,w=h.length;n<w;++n)if(void 0!==b["breakpoint_"+h[n]]&&void 0!==b["breakpoint_"+h[n]][m.id]&&b["breakpoint_"+h[n]][m.id]===m.v){r=!0;break}else if("desktop"===h[n]&&void 0!==b[m.id]&&b[m.id]===m.v){r=!0;break}if(r)continue}e[m.id]=
m.v}}return e},saveComponent:function(a){var b=null===a;b||a.preventDefault();if(c.hasChanged){var d=c.Forms,g=c.activeModel.get("elType");a="module"===g;if(!a||d.isValidate(e("#tb_module_settings",top_iframe))){e("body").trigger("themify_builder_save_component");"visual"===c.mode&&window.parent.jQuery("body").trigger("themify_builder_save_component");c.saving=!0;var f={},h=null,k=!1,l=!1,m=null,r=null,n=!1,w="styling",t=e(".tb_element_cid_"+c.activeModel.cid);if(a||"row"===g)a&&(w="mod_settings",
k=c.activeModel.get("is_new"),c.activeModel.unset("is_new",{silent:!0})),r=d.serialize("themify_builder_options_setting"),h=d.serialize("themify_builder_options_animation"),m=d.serialize("themify_builder_options_visibility"),"visual"===c.mode&&("hide_all"===m.visibility_all||"hide"===m.visibility_desktop||"hide"===m.visibility_tablet||"hide"===m.visibility_mobile?t.addClass("tb_visibility_hidden"):t.removeClass("tb_visibility_hidden"));"visual"===c.mode&&c.liveStylingInstance.remember(c.activeModel.cid);
b?e("body").trigger("themify_builder_lightbox_before_close"):ThemifyBuilderCommon.Lightbox.close(b);var d=e.extend(!0,{},c.Mixins.Common.styleData),g=e.extend(!0,{},c.activeModel.get(w)),p=d.breakpoint_desktop;delete d.breakpoint_desktop;for(var x in d)p[x]=d[x];f[w]=e.extend(!0,p,r,h,m);f[w]=c.Utils.clear(f[w]);c.activeModel.set(f,{silent:!0});a&&(k&&(l=ThemifyBuilderCommon.Lightbox.clone(t.closest(".module_column"))),c.vent.trigger("dom:builder:change"),e(".tb-import-layout-button").remove());if("visual"===
c.mode){var u=c.liveStylingInstance.getRememberedStyles();void 0===c.isComponentSaved[c.activeModel.cid]&&(c.isComponentSaved[c.activeModel.cid]=1,n=!0)}c.vent.trigger("dom:change",c.activeModel.cid,c.beforeEvent,t,"save",{old:g,"new":f[w],styles:u,column:l,first:n});c.beforeEvent=!1;c.saving=!1;b&&ThemifyBuilderCommon.Lightbox.close(b)}}else ThemifyBuilderCommon.Lightbox.close(b)},moduleOptAddRow:function(a,b){a.preventDefault();var d=e(a.currentTarget).parent().prev(),g=c.cache.repeaterElements[d.prop("id")].clone(),
f=Math.random().toString(36).substr(2,7),h=[],k=!1,l=!1,m=!a.isTrigger||b;g.removeClass("collapsed").find(".row_inner").show();var r=g[0].getElementsByClassName("tb_lb_option_child");b=b?e(b):!1;for(var n=0,w=r.length;n<w;++n){var t=e(r[n]);var p=b?b.find('[data-input-id="'+t.data("input-id")+'"]'):!1;var x=r[n].classList;if(x.contains("tb_lb_wp_editor")){var u=t.data("input-id");var q=t.data("control-repeater");var D=t.closest(".wp-editor-wrap");t=u+"_"+n+"_"+Math.random().toString(36).substr(2,
7);!1===k&&(k=D[0].innerHTML);D[0].innerHTML=k.replace(new RegExp(u,"g"),t);t=D.find(".tb_lb_wp_editor");t.attr({name:u,"data-input-id":u,"data-control-repeater":q}).data({"input-id":u,"control-repeater":q});p?(p=p.prop("id"),D=tinyMCE.get(p),p=!1===D.hidden?D.getContent():switchEditors.wpautop(tinymce.DOM.get(p).value),t.val(p)):t.val("");h.push(t)}else if(x.contains("themify-layout-icon"))D=t.find("a"),D.removeClass("selected"),p?D.filter("#"+p.find(".selected").prop("id")).addClass("selected"):
(p=themifyBuilder.modules[c.activeModel.get("mod_name")],void 0!==p&&void 0!==p.defaults&&p.defaults[u]?D.filter("#"+p.defaults[u]).addClass("selected"):D.first().addClass("selected"));else if(x.contains("themify-builder-uploader-input"))m&&(l=!0,p=!1!==p?p.val():"",D=t.val(p).parent(),q=D.find(".thumb_preview").find(".img-placeholder"),D.find(".tb-upload-btn").prop("id","pluploader_"+f+"_"+n+"themify-builder-plupload-upload-ui").addClass("plupload-clone").find(".builder_button").prop("id","pluploader_"+
f+"_"+n+"themify-builder-plupload-browse-button"),""!==p&&(p=e("<img/>",{src:p,width:50,height:50}),q.html(p)));else if(x.contains("tb-radio-input-container")){D=r[n].getElementsByClassName("themify-builder-radio-dnd");q=t.data("input-id");var B=p?p.find(":checked").val():!1;p=0;for(var z=D.length;p<z;++p){var A=e(D[p]);A.prop({name:q+"_"+f,id:q+"_"+f+"_"+p,checked:!1}).next("label").prop("for",q+"_"+f+"_"+p);(B===A.val()||!B&&A.data("checked"))&&A.prop("checked",!0)}x.contains("tb-option-radio-enable")&&
ThemifyBuilderCommon.Lightbox.clickRadioOption(null,t.find(":checked"))}else B=p?p.val():"",void 0===B&&(B=""),t.val(B);m&&(t.data("binding")&&c.Mixins.Common.doTheBinding(t,B,g),!t.data("control-binding")||x.contains("tb_lb_wp_editor")||x.contains("minicolors-input")||x.contains("themify-gradient")||c.Views.init_control(t.data("control-type"),{el:t,binding_type:t.data("control-binding"),selector:t.data("live-selector")}))}m&&setTimeout(function(){c.Utils.setColorPicker(g)},1);d[0].appendChild(g[0]);
m&&(0<h.length&&setTimeout(function(){for(var a=0,b=h.length;a<b;++a)c.Views.init_control("wp_editor",{el:h[a],binding_type:h[a].data("control-binding"),selector:h[a].data("live-selector")});h=null},1),l&&c.Utils.builderPlupload("new_elemn"))},builderImportSubmit:function(a){a.preventDefault();var b=e(this);ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.dialog_import_page_post,function(a){e.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"builder_import_submit",
nonce:themifyBuilder.tb_load_nonce,data:b.closest("form").serialize(),importType:"no"===a?"replace":"append",importTo:themifyBuilder.post_ID},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(a){c.Forms.reLoad(a,themifyBuilder.post_ID);ThemifyBuilderCommon.Lightbox.close()}})},{buttons:{no:{label:"Replace Existing Builder"},yes:{label:"Append Existing Builder"}}})},lightbox_switcher:function(a){a.preventDefault();a=e(a.currentTarget).attr("href").replace("#","");c.activeModel&&
"visual"===c.mode&&(c.scrollTo=c.liveStylingInstance.$liveStyledElmt);e(".tb_breakpoint_switcher.breakpoint-"+a,top_iframe).trigger("click")},reLoad:function(a,b){function d(){"visual"===c.mode&&(c.Utils.loadContentJs(),c.id=!1);c.vent.trigger("dom:builder:init");ThemifyBuilderCommon.showLoader("hide");"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(e("body",top_iframe).height(document.body.scrollHeight),setTimeout(function(){e("body",top_iframe).height(document.body.scrollHeight)},2E3))}c.Models.Registry.destroy();
c.Instances.Builder={};var g="";if("visual"===c.mode){var f="themify-builder-"+b+"-generated-css",h=e("link#"+f),g="#themify_builder_content-"+b;c.id=b;h.remove();void 0!==a.css&&void 0!==a.css.css_file&&(f="<link id="+f+' type="text/css" rel="stylesheet" href="'+a.css.css_file+"?tmp="+Date.now()+'" />',document.getElementById("themify-builder-admin-ui-css").insertAdjacentHTML("afterend",f));c.VisualCache=[];c.editing=!1;c.isComponentSaved=[];setTimeout(function(){c.liveStylingInstance.reset()},1);
e("body").addClass("sidebar-none full_width")}else g="#themify_builder_row_wrapper";c.Instances.Builder[0]=new c.Views.Builder({el:g,collection:new c.Collections.Rows(a.builder_data),type:"visual"});c.Instances.Builder[0].render();c.toolbar.undoManager.reset();"visual"===c.mode?c.bootstrap(null,d):d()},templateSelected:function(a){a.preventDefault();a.stopPropagation();var b=e(this).closest(".layout_preview");ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.confirm_template_selected,
function(a){var d=themifyBuilder.post_ID,f={type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_set_layout",mode:"no"===a?1:0,nonce:themifyBuilder.tb_load_nonce,layout_slug:b.data("slug"),id:d,layout_group:b.data("group")},beforeSend:function(){"visual"===c.mode&&ThemifyBuilderCommon.showLoader("show")},success:function(a){ThemifyBuilderCommon.Lightbox.close();"success"===a.status?c.Forms.reLoad(a,d):(ThemifyBuilderCommon.showLoader("error"),alert(a.msg))}};if("pre-designed"===
b.data("group")){ThemifyBuilderCommon.showLoader("show");var h=b.data("slug"),k="https://themify.me/themify-layouts/"+h+".txt",l=function(){f.data.builder_data=c.layouts_selected[h];e.ajax(f)};if(!c.layouts_selected)c.layouts_selected={};else if(c.layouts_selected[h]){l();return}e.get(k,null,null,"text").done(function(a){c.layouts_selected[h]=a;l()}).fail(function(a,b,c){ThemifyBuilderCommon.LiteLightbox.alert("There was an error in loading layout, please try again later, or you can download this file: ("+
k+") and then import manually (http://themify.me/docs/builder#import-export).")}).always(function(){ThemifyBuilderCommon.showLoader()})}else e.ajax(f)},{buttons:{no:{label:"Replace Existing Layout"},yes:{label:"Append Existing Layout"}}})},saveAsLayout:function(a){a.preventDefault();e.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_save_custom_layout",nonce:themifyBuilder.tb_load_nonce,form_data:e("#tb_save_layout_form",top_iframe).serialize()},success:function(a){"success"===
a.status?ThemifyBuilderCommon.Lightbox.close():alert(a.msg)}})},saveAsLibraryItem:function(a){if("keypress"!=a.type||13==a.keyCode)a.preventDefault(),e.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_save_custom_item",nonce:themifyBuilder.tb_load_nonce,form_data:e("#tb_library_item_form",top_iframe).serialize()},success:function(a){if("success"===a.status){c.toolbar.libraryItems.is_init=!1;ThemifyBuilderCommon.Lightbox.close();var b=e("#tb_module_panel.tb_modules_panel_wrap",
top_iframe);b.find(".tb_module_panel_search_text").val("");e(document).trigger("change:tab:tb_module_panel_library_wrap",b);if(!_.isUndefined(a.opt)){var b=e("#tmpl-builder_form_layout-part"),g=e("<div />").html(b.html());g.find("#selected_layout_part").html(a.opt);b[0].innerHTML=g.html()}if(!_.isUndefined(a.model)){var b=function(){f.replaceWith(h.el);k.trigger("custom:preview:refresh",k.get("mod_settings"))},f=e("div[data-cid='"+a.model+"']"),g=[];if(f.hasClass("themify_builder_row")){a=c.Views.init_row(a.replWith,
c.mode);var h=a.view.render();a=h.$el.find(".active_module").data("cid");var k=c.Models.Registry.lookup(a)}else k=c.Views.init_module(a.replWith,c.mode),h=k.view.render(),k=k.model;g[k.cid]=1;"visual"==c.mode?c.bootstrap(g,b):b()}}else alert(a.msg)}})},widget_actions:function(){var a={},b=!1,d=!1,g=!1;e("body",top_iframe).on("change","#class_widget",function(){var f=e(this).val(),h=e(this).find(" :selected").data("idbase"),k=b["widget-id"],l=function(h,k){var l=e("#instance_widget",top_iframe),m=
e(k.form),r=function(a){"text"===a?d||(d=!0,wp.textWidgets.init()):g||(wp.mediaWidgets.init(),g=!0);e(document).trigger("widget-added",[l]);"text"===a&&c.Views.init_control("wp_editor",{el:l.find(".wp-editor-area"),binding_type:"refresh"})},p=function(a,b,c){var d=a.length;(function(a,b,c){Themify.LoadAsync(a,b,null,null,c)})(a[b],function(){++b;b<d?p(a,b,c):r(c)})};if(b)for(var x in b)m.find('[name="'+x+'"]').val(b[x]);m.find(".widget-id").val(Math.random());m.find("select").wrap('<span class="selectwrapper"/>');
l.html(m.html());void 0===a[h]&&k.template?(document.getElementsByTagName("body")[0].insertAdjacentHTML("beforeend",k.template),0<k.src.length&&p(k.src,0,h)):k.init&&r(h,k.form);"visual"===c.mode&&f&&l.find(":input").first().trigger("change")};z.class_widget=f;void 0!==a[h]&&k===a[h].widgetID?l(h,a[h]):e.ajax({type:"POST",dataType:"json",url:themifyBuilder.ajaxurl,data:{action:"module_widget_get_form",tb_load_nonce:themifyBuilder.tb_load_nonce,load_class:f,tpl_loaded:+(0<e("#tmpl-media-modal").length),
id_base:h,widget_instance:b},success:function(b){b&&b.form&&(l(h,b),a[h]={form:b.form,init:0<b.src.length,widgetID:k})}})});e("body").on("editing_module_option",function(a,c,d,g){"widget"===c&&d.instance_widget&&(b=d.instance_widget,setTimeout(function(){e("#class_widget",g).trigger("change");b=!1},200))})},isValidate:function(a){var b=a.find("[data-validation]");if(0===b.length)return!0;var c=this,g={};b.each(function(){var a=e(this),b=a.data("validation"),d=a.val();c.checkValidate(b,d)||(g[a.prop("id")]=
a.data("error-msg"))});a.find(".tb_field_error").removeClass("tb_field_error").end().find(".tb_field_error_msg").remove();if(_.isEmpty(g))return!0;var f=0;_.each(g,function(b,c){var d=a.find("#"+c);d.addClass("tb_field_error");e("<span/>",{"class":"tb_field_error_msg","data-error-key":c}).text(b).insertAfter(d);f||(d=a.children().index(d.closest(".themify_builder_options_tab_wrapper")),(d=-1<d&&a.closest("#themify_builder_lightbox_parent").find(".themify_builder_options_tab > li").eq(d))&&!d.hasClass("current")&&
d.trigger("click"),f++)});return!1},checkValidate:function(a,b){return c.Forms.get_validator(a)(b)},clear:function(){if(c.activeModel&&(void 0!==c.activeModel.get("is_new")&&c.activeModel.trigger("dom:module:unsaved"),c.activeModel=null,void 0!==tinyMCE))for(var a=tinymce.editors.length-1;-1<a;a--)"content"!==tinymce.editors[a].id&&tinyMCE.execCommand("mceRemoveEditor",!0,tinymce.editors[a].id)}};c.Forms.register_validator=function(a,b){this.Validators[a]=b};c.Forms.get_validator=function(a){return void 0!==
this.Validators[a]?this.Validators[a]:this.Validators.not_empty};c.Forms.register_validator("email",function(a){var b=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;a=a.split(",");return!(0<e.map(a,function(a,c){return b.test(a)?null:"1"}).length)});c.Forms.register_validator("not_empty",function(a){return!(!a||""===a.trim())});c.Views.Toolbar=Backbone.View.extend({events:{"click .tb_import":"import",
"click .themify_builder_load_layout":"loadLayout","click .themify_builder_save_layout":"saveLayout","click .themify_builder_dup_link":"duplicate","click .tb_toolbar_save":"save","click .tb_toolbar_backend_edit a":"save","click .tb_toolbar_close_btn":"panelClose","click .tb_breakpoint_switcher":"breakpointSwitcher","click .themify_builder_zoom":"zoom","click .tb_toolbar_zoom_menu_toggle":"zoom","click .tb_toolbar_builder_preview":"previewBuilder"},initialize:function(){var a=[],b=this,d=this.$el.find(".tb_module_panel_modules_wrap"),
g=wp.template("builder_module_item_draggable"),f;for(f in themifyBuilder.modules)a.push(g({slug:f,name:themifyBuilder.modules[f].name,type:themifyBuilder.modules[f].type?themifyBuilder.modules[f].type:"",favorite:+themifyBuilder.modules[f].favorite}));d[0].innerHTML=a.join("")+'<span class="favorite-separator"></span>';e("#tmpl-builder_module_item_draggable").remove();"visual"===c.mode&&e("body",top_iframe)[0].appendChild(this.el);a=null;setTimeout(function(){function a(){new SimpleBar(d[0]);b.preDesignedRows.init();
b.libraryItems.init();b.common.init()}b.Panel.init();b.undoManager.init();"visual"===c.mode?(window.parent.jQuery("body").one("themify_builder_ready",a),b.unload()):a()},1);setTimeout(function(){b.Revisions.init()},800);e("body",top_iframe).on("click",".themify_module_favorite",b.toggleFavoriteModule);if("visual"===c.mode)e("body").on("click",".themify_module_favorite",b.toggleFavoriteModule);b.compactToolbar()},compactToolbar:function(){function a(){f&&clearTimeout(f);f=setTimeout(function(){d.toggleClass("compact-toolbar",
b.$el.outerWidth()<g)},50)}var b=this,d=e("body",top_iframe),g="visual"===c.mode?850:750,f;window.top.jQuery("body").on("themify_builder_ready",a);e(window.top).on("resize",a);b.$el.find(".tb_toolbar_divider").each(function(){var a=e(this).nextUntil(".tb_toolbar_divider");if(1<a.length&&!a.eq(0).hasClass("tb_toolbar_compact_item")){var b=a.clone();a.eq(0).addClass("tb_toolbar_compact_item").append('<ul class="tb_compact_group"></ul>').find(".tb_compact_group").append(b)}})},"import":function(a){a.preventDefault();
a=ThemifyBuilderCommon.detectBuilderComponent(e(a.currentTarget));var b=null,d={dataType:"html",data:{action:"builder_import",type:a}};if("file"!==a||confirm(themifyBuilder.i18n.importFileConfirm))"file"===a&&(b=function(){c.Utils.builderPlupload("",!0)}),ThemifyBuilderCommon.Lightbox.open(d,null,b)},unload:function(){var a=this;"visual"===c.mode&&document.getElementsByTagName("head")[0].insertAdjacentHTML("afterbegin",'<base target="_parent">');window.parent.onbeforeunload=function(){return!c.editing&&
a.undoManager.hasUndo()?"Are you sure":null}},panelClose:function(a){a.preventDefault();ThemifyBuilderCommon.inLightboxIframe()?(e(".tb_toolbar_backend_edit",highest_iframe).show(),"visual"==c.mode&&(e(".themify_builder_workspace_container",highest_iframe).css({margin:highest_iframe.layoutpart.margin}),e("#tb_toolbar",highest_iframe).show(),highest_iframe.layoutpart.model()),e(window.highest_iframe.layoutpart.overlay).css({backgroundColor:"initial"}).hide().siblings(".tb_layoutpart_lightbox").remove(),
e(window.highest_iframe.layoutpart.overlay).remove()):window.parent.location.reload(!0)},undoManager:{stack:[],is_working:!1,index:-1,btnUndo:document.getElementsByClassName("tb-undo-btn")[0],btnRedo:document.getElementsByClassName("tb-redo-btn")[0],init:function(){var a=this;c.toolbar.$el.find(".tb-undo-redo").on("click",this.do_change.bind(this));if(!themifyBuilder.disableShortcuts&&(e(top_iframe).on("keydown",this.keypres.bind(this)),"visual"===c.mode))e(document).on("keydown",this.keypres.bind(this));
c.vent.on("dom:change",function(b,d,g,f,h){c.hasChanged&&(c.editing=!1,g&&(g=ThemifyBuilderCommon.Lightbox.clone(g)),"visual"!==c.mode||"duplicate"!==f&&"sort"!==f||e(window).trigger("tfsmartresize.tfVideo"),a.stack.splice(a.index+1,a.stack.length-a.index),a.stack.push({cid:b,type:f,data:h,before:d,after:g}),a.index=a.stack.length-1,a.updateUndoBtns(),"visual"===c.mode&&e("body").trigger("builder_dom_changed",[f]))})},set:function(a){var b=a[0].querySelectorAll("[data-cid]"),b=Array.prototype.slice.call(b);
b.unshift(a[0]);a=0;for(var d=b.length;a<d;++a){var g=c.Models.Registry.lookup(b[a].getAttribute("data-cid"));g&&g.trigger("change:view",b[a])}},doScroll:function(a){("visual"!==c.mode||"desktop"===c.activeBreakPoint?e("body"):e("body",top_iframe)).scrollTop(a.offset().top)},keypres:function(a){if(90===a.which&&"INPUT"!==document.activeElement.tagName&&"TEXTAREA"!==document.activeElement.tagName)if(!0===a.ctrlKey&&!0===a.shiftKey||!0===a.metaKey&&!0===a.shiftKey)a.preventDefault(),this.hasRedo()&&
this.changes(!1);else if(!0===a.ctrlKey||!0===a.metaKey)a.preventDefault(),this.hasUndo()&&this.changes(!0)},changes:function(a){var b=this.stack[this.index+(a?0:1)];if(void 0!==b){this.is_working=!0;var d="";var g=b.type,f=e(".tb_element_cid_"+b.cid);var h=!1;if("row"===g)a?(d=b.before.clone(!0),h=b.cid):(d=b.after.clone(!0),h=b.before.data("cid"),f=e(".tb_element_cid_"+h)),this.set(d),f.replaceWith(d);else if("duplicate"===g)a?e(".tb_element_cid_"+b.after.data("cid")).remove():(d=b.after.clone(!0),
h=b.before.data("cid"),this.set(d),f.after(d));else if("delete_row"===g)a?(d=b.before.clone(!0),h=b.cid,f=e(".tb_element_cid_"+b.data.pos_cid),this.set(d),"after"===b.data.pos?f.after(d):f.before(d)):f.remove();else if("sort"===g)h=b.cid,a?(f=b.data.after,g=b.data.before,d=b.before.clone(!0)):(f=b.data.before,g=b.data.after,d=b.after.clone(!0),"visual"===c.mode&&d.find(".active_module").css({display:"block",height:"auto"})),this.set(d),e(".tb_element_cid_"+f).find(".tb_element_cid_"+h).remove(),e(".tb_element_cid_"+
g).replaceWith(d);else if("save"===g){h=b.cid;var g=c.Models.Registry.lookup(h),k="module"===g.get("elType"),l={},m=k?"mod_settings":"styling";k&&b.data.column?a?(h=!1,f.remove()):(h=b.data.column.data("cid"),d=b.data.column.clone(!0),f=e(".tb_element_cid_"+h),this.set(d),f.replaceWith(d)):(a?(l[m]=b.data.old,d=b.before.clone(!0)):(l[m]=b.data["new"],d=b.after.clone(!0)),g.set(l,{silent:!0}),this.set(d),f.replaceWith(d),"visual"===c.mode&&c.liveStylingInstance.doUndo(b.data.styles,a?b.data.first:
!1))}else if("predesign"===g)if(f=b.data.rows,a)for(g=0,k=f.length;g<k;++g)e(".tb_element_cid_"+f[g].data("cid")).remove();else{l=document.createDocumentFragment();d=[];g=0;for(k=f.length;g<k;++g)m=ThemifyBuilderCommon.Lightbox.clone(f[g]),l.appendChild(m[0]),d.push(m);!1!==b.data.prev?e(".tb_element_cid_"+b.data.prev).after(l):e("#themify_builder_content-"+b.data.bid).prepend(l);g=0;for(k=d.length;g<k;++g)this.set(d[g]),c.Mixins.Builder.update(d[g])}else if("import"===g){var f=e('[data-postid="'+
b.data.bid+'"]'),b=a?b.data.before.clone(!0):b.data.after.clone(!0),r=this;f.children().remove();f.prepend(b);b.each(function(){r.set(e(this))})}h&&c.Mixins.Builder.update(d);a?this.index--:this.index++;this.is_working=!1;this.updateUndoBtns()}},hasRedo:function(){return this.index<this.stack.length-1},hasUndo:function(){return-1!==this.index},disable:function(){this.btnUndo.classList.add("tb_disabled");this.btnRedo.classList.add("tb_disabled");this.btnUndo.parentNode.classList.contains("tb_toolbar_compact_item")&&
(this.btnUndo.parentNode.querySelector(".tb_compact_group .tb-undo-btn").classList.add("tb_disabled"),this.btnUndo.parentNode.querySelector(".tb_compact_group .tb-redo-btn").classList.add("tb_disabled"))},updateUndoBtns:function(){this.btnUndo.classList.toggle("tb_disabled",!this.hasUndo());this.btnRedo.classList.toggle("tb_disabled",!this.hasRedo());this.btnUndo.parentNode.classList.contains("tb_toolbar_compact_item")&&(this.btnUndo.parentNode.querySelector(".tb_compact_group .tb-undo-btn").classList.toggle("tb_disabled",
!this.hasUndo()),this.btnUndo.parentNode.querySelector(".tb_compact_group .tb-redo-btn").classList.toggle("tb_disabled",!this.hasRedo()))},reset:function(){this.stack=[];this.index=-1;this.updateUndoBtns()},do_change:function(a){a.preventDefault();!1===this.is_working&&-1===a.currentTarget.className.indexOf("tb_disabled")&&this.changes(-1!==a.currentTarget.className.indexOf("tb-undo-btn"))}},loadLayout:function(a){function b(a){a.each(function(a){0===a%4?e(this).addClass("layout-column-break"):e(this).removeClass("layout-column-break")})}
a.preventDefault();var c=this;ThemifyBuilderCommon.Lightbox.open(c.layouts_list?{loadMethod:"html",data:c.layouts_list}:{data:{action:"tb_load_layout"}},null,function(a){function d(){var a=g.find(".layout_preview_list");k.show().find("a").on("click",function(c){c.preventDefault();e(this).hasClass("selected")||(c=a,e(this).hasClass("all")||(a.hide(),c=a.filter('[data-category*="'+e(this).text()+'"]')),c.show(),b(c),k.find("a").removeClass("selected"),e(this).addClass("selected"),k.parent().find(".tb_filter_layouts").html(e(this).text()))});
g.find("#themify_builder_layout_search").on("keyup",function(){var c=e.trim(e(this).val()),d=a;""!==c&&(d=k.find("a.all"),d.hasClass("selected")||d.click(),a.hide(),d=a.find(".layout_title:contains("+c+")").closest(".layout_preview_list"));d.show();b(d)})}a=e(a);var g=a.find("#themify_builder_tabs_pre-designed"),k=g.find("#themify_builder_pre-designed-filter");0!=g.length&&(c.layouts_list?d():(ThemifyBuilderCommon.showLoader("show"),e.getJSON("https://themify.me/themify-layouts/index.json").done(function(f){var h=
window.parent.wp.template("themify-builder-layout-item"),l={},n="";f=e(h(f));f.find("li").each(function(){for(var a=e(this).data("category").split(","),b=0,c=a.length;b<c;++b)""!==a[b]&&void 0===l[a[b]]&&(n+='<li><a href="#">'+a[b]+"</a></li>",l[a[b]]=1)});l=null;k[0].insertAdjacentHTML("beforeend",n);g[0].insertAdjacentHTML("beforeend",f[0].outerHTML);a.find(".themify_builder_tab").each(function(){b(e(this).find(".layout_preview_list"))});c.layouts_list=a[0];d();new SimpleBar(a[0])}).fail(function(a,
b,c){ThemifyBuilderCommon.LiteLightbox.alert(e("#themify_builder_load_layout_error",g).show().text())}).always(function(){ThemifyBuilderCommon.showLoader("spinhide")})))})},saveLayout:function(a){a.preventDefault();ThemifyBuilderCommon.Lightbox.open({data:{action:"tb_custom_layout_form",postid:themifyBuilder.post_ID}},function(){c.Utils.builderPlupload("normal")})},duplicate:function(a){function b(){d.Revisions.ajax({action:"tb_duplicate_page",tb_is_admin:"visual"!==c.mode},function(a){a&&(window.parent.location.href=
e("<div/>").html(a).text())})}a.preventDefault();var d=this;confirm(themifyBuilder.i18n.confirm_on_duplicate_page)?c.Utils.saveBuilder(b):b()},Revisions:{init:function(){c.toolbar.$el.find(".tb_revision").on("click",this.revision.bind(this));e("body",top_iframe).on("click",".js-builder-restore-revision-btn",this.restore.bind(this)).on("click",".js-builder-delete-revision-btn",this["delete"].bind(this))},revision:function(a){a.preventDefault();a.currentTarget.classList.contains("tb_save_revision")?
this.save():this.load()},load:function(){ThemifyBuilderCommon.Lightbox.open({data:{action:"tb_load_revision_lists",postid:themifyBuilder.post_ID,tb_load_nonce:themifyBuilder.tb_load_nonce}})},ajax:function(a,b){a=e.extend({},a,{tb_load_nonce:themifyBuilder.tb_load_nonce,postid:themifyBuilder.post_ID});return e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:a,beforeSend:function(){ThemifyBuilderCommon.showLoader("show")},complete:function(){ThemifyBuilderCommon.showLoader("hide")},success:function(a){e.isFunction(b)&&
b.call(this,a)}})},save:function(a){var b=this;ThemifyBuilderCommon.LiteLightbox.prompt(themifyBuilder.i18n.enterRevComment,function(d){null!==d&&c.Utils.saveBuilder(function(){b.ajax({action:"tb_save_revision",rev_comment:d},a)},"main",0,!0)})},restore:function(a){a.preventDefault();var b=e(a.currentTarget).data("rev-id"),d=this,g=function(){d.ajax({action:"tb_restore_revision_page",revid:b},function(a){a.status?(c.Forms.reLoad(a,themifyBuilder.post_ID),ThemifyBuilderCommon.Lightbox.close()):(ThemifyBuilderCommon.showLoader("error"),
...
a.stopPropagation();var b=0<e(a.currentTarget).closest(".tb_toolbar_backend_edit").length?e(a.currentTarget).prop("href"):!1;c.Utils.saveBuilder(function(a,e){"success"!==e?alert(themifyBuilder.i18n.errorSaveBuilder):!1!==b&&("visual"===c.mode?(sessionStorage.setItem("focusBackendEditor",!0),window.parent.location.href=b):(c.toolbar.undoManager.reset(),c._backendSwitchFrontend()))})},libraryItems:{is_init:null,items:[],subTab_toolbar:null,init:function(){e(document).on("change:tab:tb_module_panel_library_wrap",
this.load.bind(this));c.toolbar.common.subTab_btn=this.subTab_toolbar=c.toolbar.$el.find("ul.tb_library_types li.active a").data("type")},get:function(a,b){return _.isUndefined(this.items[b])||this.items[b].type!=a?!1:this.items[b].data},load:function(a,b,d){if(!this.is_init){b=e(b);var g=this;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,pid:themifyBuilder.post_ID},beforeSend:function(a){b.addClass("tb_busy")},success:function(a){g.setData(g.subTab_toolbar,
a,b,d);b.removeClass("tb_busy")},error:function(){b.removeClass("tb_busy");ThemifyBuilderCommon.showLoader("error");this.is_init=!1;c.toolbar.$el.find(".tb_library_item_list").html("<h3>Failed to load Library Items.</h3>")}})}},setData:function(a,b,d,g){if(!this.is_init){a='<span id="no-content" style="display:none">No library content found.</span>';d=c.toolbar.$el.find(".tb_library_item_list");b="string"===typeof b?JSON.parse(b):b;if("object"===typeof b||"array"===typeof b){this.items=[];for(var f=
0,h=b.length;f<h;++f)this.items.push({type:b[f].type,data:b[f]}),a+='<div class="dragable_library_item dragable_library_item_'+b[f].type+'" data-id="'+f+'" data-type="library_item" data-main="'+b[f].type+'">',a+='<div class="dragable_library_item_inner"><span>'+b[f].title+"</span>",a+='<a href="#" class="remove_item_btn" title="Delete" ondragstart="return false;"></a></div></div>'}d[0].innerHTML=a;new SimpleBar(d[0]);this.set_subTab();this.change(this.subTab_toolbar,c.toolbar.$el);e(document).trigger("update:tb_btn",
"tb_module_panel_library_wrap",g);this.is_init=!0;c.toolbar.common.library_load=!0}},change:function(a,b){b.find(".dragable_library_item, #no-content").hide();0<b.find(".dragable_library_item_"+a).length?b.find(".dragable_library_item_"+a).show():b.find("#no-content").show()},set_subTab:function(a){function b(a){a.preventDefault();a.stopPropagation();var b=e(a.currentTarget),d=b.data("type"),f=b.closest("#tb_plus_btn_popover.tb_modules_panel_wrap");0>=f.length&&(f=e(a.target,top_iframe).closest("#tb_module_panel.tb_modules_panel_wrap"));
f.find(".tb_module_panel_search_text").val("");b.closest("li").addClass("active").siblings().removeClass("active");"tb_module_panel"===f.prop("id")?g.subTab_toolbar=d:c.toolbar.common.subTab_btn=d;g.is_init?g.change(d,f):e(document).trigger("change:tab:tb_module_panel_library_wrap",f)}function d(a){g["delete"](a,g)}var g=this;"btn"==a?(c.toolbar.common.btn.find(".tb_library_types").off("click","a").on("click","a",b.bind(this)),c.toolbar.common.btn.find("a.remove_item_btn").off("click").on("click",
d.bind(this))):(c.toolbar.$el.find(".tb_library_types").off("click","a").on("click","a",b.bind(this)),c.toolbar.$el.find("a.remove_item_btn").off("click").on("click",d.bind(this)))},"delete":function(a,b){a.preventDefault();a.stopPropagation();var d=e(a.target).closest(".dragable_library_item"),g=b.items[d.data("id")].type,f=e(a.target).closest("#tb_plus_btn_popover.tb_modules_panel_wrap");0>=f.length&&(f=e(a.target,top_iframe).closest("#tb_module_panel.tb_modules_panel_wrap"));b.items&&!_.isUndefined(b.items[d.data("id")])&&
confirm(themifyBuilder.i18n[g+"LibraryDeleteConfirm"])&&e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_remove_library_item",nonce:themifyBuilder.tb_load_nonce,pid:b.items[d.data("id")].data.pid},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(a){b.is_init=!1;if(!_.isUndefined(a.opt)){var d=e("#tmpl-builder_form_layout-part"),g=e("<div />").html(d.html());g.find("#selected_layout_part").html(a.opt);d[0].innerHTML=g.html();var d=c.Models.Registry.items,
h;for(h in d)"module"==d[h].get("elType")&&"layout-part"==d[h].get("mod_name")&&a.part==d[h].get("mod_settings").selected_layout_part&&d[h].destroy()}ThemifyBuilderCommon.showLoader("hide");c.toolbar.$el.find(".tb_library_item_list").empty();e(document).trigger("change:tab:tb_module_panel_library_wrap",f)},error:function(){ThemifyBuilderCommon.showLoader("error")}})}},preDesignedRows:{is_init:null,rows:{},filter_toolbar:null,init:function(){setTimeout(function(){document.getElementsByTagName("head")[0].insertAdjacentHTML("afterbegin",
'<meta http-equiv="x-dns-prefetch-control" content="on"/><link href="//themify.me" rel="dns-prefetch preconnect"/><link href="//fonts.googleapis.com" rel="dns-prefetch"/><link href="//maps.google.com" rel="dns-prefetch"/><link href="https://themify.me/public-api/predesigned-rows/index.json" rel="prefetch"/>')},7E3);e(document).on("tb_setpredesignedrows",this.get.bind(this));e(document).on("tb_setpremaderows",this.grid.bind(this));e(document).on("change:tab:tb_module_panel_rows_wrap",this.load.bind(this))},
load:function(a,b,d){if(null===this.is_init){this.is_init=!0;var g=this;b=e(b);b.addClass("tb_busy");e.getJSON("https://themify.me/public-api/predesigned-rows/index.json").done(function(a){g.setData(a,b,d)}).fail(function(a,b,d){this.is_init=null;ThemifyBuilderCommon.showLoader("error");c.toolbar.$el.find(".tb_predesigned_rows_list").html("<h3>Failed to load Pre-Designed Rows from server.</h3>")})}},setData:function(a,b,d){for(var g=[],f="",h="",k=0,l=a.length;k<l;++k){for(var m=a[k].category.split(","),
r="",n=0,w=m.length;n<w;++n)-1===g.indexOf(m[n])&&g.push(m[n]),r+=" tb"+Themify.hash(m[n]);if(void 0===a[k].thumbnail||""===a[k].thumbnail)a[k].thumbnail="https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(a[k].title)+"&w=181&h=77";h+='<div class="predesigned_row'+r+'" data-slug="'+a[k].slug+'"><figure class="tb_predesigned_rows_list_image">';h+='<img alt="'+a[k].title+'" title="'+a[k].title+'" src="'+a[k].thumbnail+'" /></figure>';h+='<div class="tb_predesigned_rows_list_title">'+a[k].title+
"</div></div>"}a=null;g.sort();g.unshift("Empty Rows");k=0;for(l=g.length;k<l;++k)a="Empty Rows"!=g[k]?Themify.hash(g[k]):"-empty-rows",f+='<li><a href="#" data-slug="'+a+'">'+g[k]+"</li>";c.toolbar.$el.find(".tb_row_filter")[0].insertAdjacentHTML("beforeend",f);var t=c.toolbar.$el.find(".tb_predesigned_rows_list");t[0].insertAdjacentHTML("beforeend",h);var p=this;t.find("img").last().one("load",function(){p.filter();b.removeClass("tb_busy");new SimpleBar(t[0]);e(document).trigger("update:tb_btn",
"tb_module_panel_rows_wrap",d);c.toolbar.common.preDesign_load=!0})},grid:function(a,b,c){a=[];if(1==b)a.push({grid_class:"col-full"});else for(var d=0;d<b;d++)a.push({column_order:d,grid_class:"col"+b+"-1"});c([{row_order:"0",cols:a}])},get:function(a,b,c){ThemifyBuilderCommon.showLoader("show");if(void 0!==this.rows[b])"function"===typeof c&&c(this.rows[b]);else{var d=this;e.getJSON("https://themify.me/public-api/predesigned-rows/"+b+".txt").done(function(a){d.rows[b]=a;"function"===typeof c&&c(a)}).fail(function(a,
b,c){ThemifyBuilderCommon.showLoader("error");alert("Failed to fetch row template")})}},filter:function(){function a(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget);var b=a.data("slug"),g=a.closest(".tb_modules_panel_wrap"),f=g.find(".tb_row_filter_active"),h=g.find(".predesigned_row");f.text(a.text());g.find(".tb_module_panel_search_text").val("");if(b){var k="tb"+b;h.each(function(){e(this).hasClass(k)?e(this).show():e(this).hide()})}else h.show();"tb_module_panel"===g.prop("id")?
this.filter_toolbar=k:c.toolbar.common.filter_btn=k}c.toolbar.$el.find(".tb_row_filter").on("click","a",a.bind(this));setTimeout(function(){c.toolbar.common.btn.find(".tb_row_filter").on("click","a",a.bind(this))},100)}},common:{btn:null,clicked:null,filter_btn:null,preDesign_load:!1,library_load:!1,subTab_btn:"",init:function(){this.btn=e('<div class="tb_modules_panel_wrap" id="tb_plus_btn_popover"></div>');e("body").append(this.btn);var a=this;this.btn.on("click",".add_module_btn",function(b){c.toolbar.Panel.add_module(b,
a.clicked.closest(".module_row").find(".themify_module_holder").last());a.clicked=null;a.btn.hide()}).on("keyup",".tb_module_panel_search_text",this.search.bind(this));c.toolbar.$el.find(".tb_module_panel_search_text").on("keyup",this.search.bind(this));if("visual"===c.mode)c.toolbar.$el.find(".tb_module_types a").on("click",this.tabs.bind(this));e("body").on("click",".tb_module_types a",this.tabs.bind(this)).on("click",".tb_row_btn_plus",this.show.bind(this));e(document).on("update:tb_btn",this.btnData.bind(this));
this.firstRun()},firstRun:function(){var a=c.toolbar.$el.find("#tb_module_panel");this.btn[0].insertAdjacentHTML("beforeend",a[0].innerHTML);this.btn.find(".tb_module_panel_lock").remove();this.btn.find(".themify_builder_module_outer").show();this.btn.find(".tb_module_panel_search_text").val("");new SimpleBar(this.btn.find(".tb_module_panel_modules_wrap")[0]);c.Mixins.Builder.initModuleDraggable(this.btn)},btnData:function(a,b,d){a=c.toolbar.$el.find("."+b);this.btn.find("."+b).html(a.html());this.btn.find(".tb_module_panel_lock").remove();
this.btn.find(".themify_builder_module_outer").show();this.btn.find(".tb_module_panel_search_text").val("");"visual"===c.mode?(c.Mixins.Builder.initRowVisualDrag(),c.Mixins.Builder.initRowGridVisualDrag(),c.Mixins.Builder.initModuleVisualDrag()):(c.Mixins.Builder.initRowDraggable(c.toolbar.$el),c.Mixins.Builder.initGridsDraggable(c.toolbar.$el),c.Mixins.Builder.initModuleDraggable(c.toolbar.$el));c.toolbar.libraryItems.set_subTab("btn");new SimpleBar(this.btn.find("."+b)[0]);c.Mixins.Builder.initModuleDraggable(this.btn);
c.Mixins.Builder.initRowDraggable(this.btn);c.Mixins.Builder.initGridsDraggable(this.btn);"function"===typeof d&&d()},tabs:function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget);var b=a.data("target"),c=a.closest(".tb_modules_panel_wrap");e(document).trigger("change:tab:"+b,c);c.find("."+b).show().siblings(".tb_module_panel_tab").hide();a.closest("li").addClass("active").siblings().removeClass("active");c.find(".tb_module_panel_search_text").val("")},show:function(a){function b(){"visual"===
...
b);null!==this.is_init&&b();this.hide()},hide:function(){function a(d){b.btn.is(":hover")||(b.btn.hide(),b.clicked=null,e(document).off("click",a),e(top_iframe).off("click",a),"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(e("body",top_iframe).height(document.body.scrollHeight),e("body").css("padding-bottom","")))}var b=this;if("visual"===c.mode)e(top_iframe).on("click",a);e(document).on("click",a)},search:function(a){a=e(a.currentTarget);var b=a.closest(".tb_modules_panel_wrap"),d="tb_module_panel_modules_wrap"===
b.find(".tb_module_types .active a").data("target"),g="tb_module_panel_library_wrap"===b.find(".tb_module_types .active a").data("target"),f="tb_module_panel_rows_wrap"===b.find(".tb_module_types .active a").data("target"),h=d||g||!c.toolbar.preDesignedRows.is_init?!1:"tb_module_panel"===b.prop("id")?c.toolbar.preDesignedRows.filter_toolbar:this.filter_btn,k=d||f||!c.toolbar.libraryItems.is_init?!1:"tb_module_panel"===b.prop("id")?c.toolbar.libraryItems.subTab_toolbar:this.subTab_btn,b=d?b.find(".themify_builder_module_outer"):
c.toolbar.preDesignedRows.is_init&&!g?b.find(".predesigned_row"):c.toolbar.libraryItems.is_init&&g?b.find(".dragable_library_item"):!1;a=e.trim(a.val());if(!1!==b){var l=""===a,m=l?!1:new RegExp(a,"i");b.each(function(){if(h&&!e(this).hasClass(h)||g&&!e(this).hasClass("dragable_library_item_"+k))return!0;var a=d?e(this).find(".module_name"):g?e(this).find(".dragable_library_item_inner span"):e(this).find(".tb_predesigned_rows_list_title");l||m.test(a.text())?e(this).show():e(this).hide()})}}},breakpointSwitcher:function(a){function b(){g.responsive_grids(f,
l);"visual"===c.mode&&m.css("will-change","auto");k.toggleClass("tb_responsive_mode","desktop"!==f).removeClass("builder-breakpoint-"+l).addClass("builder-breakpoint-"+f);e("body").trigger("themify_builder_change_mode",[l,f]);"visual"===c.mode?(c.Mixins.Builder.updateModuleSort(null,"desktop"===f?"enable":"disable"),c.Utils._onResize(!0,function(){g.iframeScroll("desktop"!==f);e("body",top_iframe).height("desktop"!==f?document.body.scrollHeight:"auto");c.scrollTo&&setTimeout(function(){e(window).add(top_iframe).scrollTop(c.scrollTo.offset().top);
c.scrollTo=!1},500);setTimeout(function(){c.Utils.setCompactMode(document.getElementsByClassName("module_column"));k.removeClass("tb_start_animate")},200)})):k.removeClass("tb_start_animate")}a.preventDefault();if(themifyBuilder.is_premium){var d="",g=this,f="desktop",h=e(a.currentTarget),k=e("body",top_iframe),l=c.activeBreakPoint;h.hasClass("breakpoint-tablet")?f="tablet":h.hasClass("breakpoint-tablet_landscape")?f="tablet_landscape":h.hasClass("breakpoint-mobile")&&(f="mobile");if(l===f&&void 0!==
a.originalEvent)return!1;c.activeBreakPoint=f;"visual"===c.mode&&(k=k.add("body"));k.addClass("tb_start_animate");"desktop"!==f&&(d=c.Utils.getBPWidth(f)-1);if("visual"===c.mode){var m=e("#themify_builder_site_canvas_iframe",top_iframe);e(".tb_toolbar_zoom_menu",top_iframe).removeClass("tb_toolbar_zoom_active").find(".tb_toolbar_zoom_menu_toggle").data("zoom",100);d="tablet_landscape"===f&&ThemifyBuilderCommon.Lightbox.dockMode.get()&&e(".themify_builder_workspace_container",top_iframe).width()<d?
e(".themify_builder_workspace_container",top_iframe).width():d;c.isPreview&&(a={tablet_landscape:1024,tablet:768,mobile:375},f in a&&(d=a[f]));d&&m.width()!=d?m.css("will-change","width").one(c.Utils.transitionPrefix(),b).css("width",d).parent().removeClass("themify_builder_zoom_bg"):(m.css("width",d).parent().removeClass("themify_builder_zoom_bg"),b())}else b()}},iframeScroll:function(a){var b=e(top_iframe);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",function(){window.scrollTo(0,
e(this).scrollTop())})},responsive_grids:function(a,b){for(var c=document.querySelectorAll(".row_inner,.subrow_inner"),g="desktop"===a,f=g||"desktop"===b,h=0,k=c.length;h<k;++h){var l=c[h].getAttribute("data-basecol");if(l){var m=c[h].children,r=c[h].dataset["col_"+a],n=m[0],w=m[m.length-1];if(!g){if("desktop"!==b){c[h].classList.remove("tb_3col");var t=c[h].getAttribute("data-col_"+b);t&&c[h].classList.remove(e.trim(t.replace("tb_3col","").replace("mobile","column").replace("tablet","column")))}if(r&&
"-auto"!==r){if(r=c[h].getAttribute("data-col_"+a)){c[h].classList.add("tb_grid_classes");c[h].classList.add("col-count-"+l);var r=r.split(" "),p;for(p in r)c[h].classList.add(e.trim(r[p].replace("mobile","column").replace("tablet","column")))}}else c[h].classList.remove("tb_grid_classes"),c[h].classList.remove("col-count-"+l)}if(f)for(l=0,r=m.length;l<r;++l)t=e(m[l]).data("w"),void 0!==t&&(m[l].style.width=g?t+"%":"");"rtl"===c[h].getAttribute("data-"+a+"_dir")?(n.classList.remove("first"),n.classList.add("last"),
...
b=a.data("handle"),"module"!==b){d=a.closest(".module_"+b);g=c.Models.Registry.lookup(d.data("cid"));var r=[];b=d.find("."+b+"_inner").first();var n=g.get("gutter"),w=g.get("column_alignment");f=g.get("desktop_dir");for(var t=g.get("styling"),p="",x={},u=b[0].children,q=0,z=u.length;q<z;++q)r.push(c.Utils._getColClass(u[q].className.split(" "))),u[q].className=u[q].className.replace(/first|last/ig,""),1!==z&&(0===q?u[q].className+="rtl"===f?" last":" first":q===z-1&&(u[q].className+="rtl"===f?" first":
" last"));r=a.find(".themify_builder_grid_desktop .grid-layout-"+r.join("-"));q=r.data("col");0<r.length&&(r.parent().addClass("selected").siblings().removeClass("selected"),d.addClass("col-count-"+q),p="col-count-"+q,x["data-basecol"]=q);"ltr"!==f&&(p+=" direction-rtl");for(q=0;4>q;++q)f=g.get(k[q]+"_dir"),"ltr"!==f&&""!==f&&(x["data-"+k[q]+"_dir"]=f,r=a.find(".themify_builder_grid_"+k[q]+" .column-dir-"+f),r.parent().addClass("selected").siblings().removeClass("selected")),"desktop"!==k[q]&&(f=
g.get("col_"+k[q]),"-auto"!==f&&""!==f&&void 0!==f&&(x["data-col_"+k[q]]=f,r=a.find(".themify_builder_grid_"+k[q]+" .grid-layout-"+f.replace(/column|tb_3col/ig,"")),r.parent().addClass("selected").siblings().removeClass("selected")));t&&void 0!==t.row_anchor&&""!==t.row_anchor&&d.find(".row-anchor-name").first().text(t.row_anchor);"col_align_top"!==w&&(a.find(".column-alignment-"+w).parent().addClass("selected").siblings().removeClass("selected"),p+=" "+w);"gutter-default"!==n&&(a.find(".gutter_select").val(n),
...
(u=C?g.prev(".module_column"):g.next(".module_column"),h=a.outerWidth()):(u=C?g.next(".module_column"):g.prev(".module_column"),h=g.outerWidth());q=u.outerWidth()-2;G=e.position.left;A=b.outerWidth()},stop:function(a,h){e(".themify_grid_drag_placeholder").remove();var n=Math.ceil(100*(g.outerWidth()/A));g.css("width",n+"%");var p=k,n=3.2;b.hasClass("gutter-narrow")?(p=l,n=1.6):b.hasClass("gutter-none")&&(p=m,n=0);var r=n*(d.length-1);d.each(function(a){a!==u.index()&&(e(this).prop("style").width?
a=parseFloat(e(this).prop("style").width):(a=e.trim(f.filterClass(e(this).attr("class")).replace("first","").replace("last","")),a=p[a]),r+=a)});u.css("width",100-r+"%");u=u.add(g);f.setCompactMode(u);n=b.closest(".module_row");c.vent.trigger("dom:change",n.data("cid"),z,n,"row")},drag:function(a,b){if(u&&0<u.length){var c=h+("e"===x?-b.position.left:b.position.left),d=parseFloat(100*c/A);if(5<=d&&100>d){var e=q+G+("w"===x?-b.position.left:b.position.left),k=parseFloat(100*e/A);5<k&&100>k&&(u.css("width",
...
b.next(".tb_shortcode_preview"),g="";0===c.length&&(c=e('<div class="tb_shortcode_preview"></div>'),b.after(c));for(var f=0,h=a.length;f<h;++f)var k=a[f].attributes,g=g+('<img src="'+(k.sizes.thumbnail?k.sizes.thumbnail.url:k.url)+'" width="50" height="50" />');c[0].innerHTML=g},createGradientPicker:function(a,b,d){var g=a.closest(".themify-gradient-field"),f=null,h=!1,k=a.data("id"),l=g.find("#"+k+"-gradient-angle"),m=a.prev(),r={angle:l.val(),onChange:function(b,d){h&&(b=d="");"visual"===c.mode&&
("cover_gradient"===k||"cover_gradient_hover"===k?c.liveStylingInstance.addOrRemoveComponentOverlay(k,d):c.liveStylingInstance.bindBackgroundGradient(k,d));a.val(b);themifybuilderapp.hasChanged=!0},onInit:function(){m.show()}};r.gradient=b?b:a.data("default-gradient")?a.data("default-gradient"):void 0;d||m.ThemifyGradient(r);f=a.prev().data("themifyGradient");b=g.find("#"+k+"-gradient-type");var n=g.find("#"+k+"-circle-radial input"),w=function(a){var b=l.parent(".gradient-angle-knob"),c=g.find("#"+
k+"-circle-radial");"radial"===a?(b.hide(),b.next("span").hide(),c.show()):(b.show(),b.next("span").show(),c.hide())};d?(f.settings=e.extend({},f.settings,r),f.settings.type=b.val(),f.settings.circle=n.is(":checked"),f.isInit=!1,f.update(),f.isInit=!0):(g.find(".themify-clear-gradient").on("click",function(a){a.preventDefault();h=!0;f.settings.gradient=e.ThemifyGradient["default"];f.update();h=!1}),b.on("change",function(a){f.setType(e(this).val());w(e(this).val())}),n.on("change",function(){f.setRadialCircle(e(this).is(":checked"))}),
