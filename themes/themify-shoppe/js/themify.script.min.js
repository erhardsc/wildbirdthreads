...
this.layout()},layout:function(){var b=!a("body").hasClass("rtl");a(".loops-wrapper.masonry").each(function(){var c=a(this);"block"!==c.css("display")&&c.css("display","block");c.imagesLoaded().always(function(){c.addClass("masonry-done").isotope({fitRows:{columnWidth:".grid-sizer",gutter:".gutter-sizer"},layoutMode:"fitRows",itemSelector:".loops-wrapper > .post,.loops-wrapper > .product",isOriginLeft:b})})})}};a(document).ready(function(b){function a(a){var c=b('<div class="post-tiled tiled-square-small" style="visibility: hidden !important; opacity: 0;" />').appendTo(a.first()),
...
null,null,function(){return"undefined"!==typeof b.fn.themify_tiles})},null,null,function(){return"undefined"!==typeof Tiles}):(a(e),g(e)));var k=b("#search-lightbox-wrap");if(0<k.length){var m=[],l,r=k.find("#searchform input"),h=k.find(".search-results-wrap");b(".search-button, #close-search-box").click(function(a){a.preventDefault();b(this).hasClass("search-button")?(k.fadeIn(function(){r.focus();d.css("overflow-y","hidden")}),b("body").addClass("searchform-slidedown")):(l&&l.abort(),k.fadeOut(),
...
d||"grid2"===d||"grid4"===d?a.show():(a.hide(),"auto_tiles"===d?c.hide():c.show())});b("body").on("editing_module_option",function(a,d){0<b("#themify_builder_lightbox_parent .masonry_post").length&&setTimeout(function(){var a=0<b("#themify_builder_lightbox_parent #layout_post").length?"#layout_post":"#layout_products",d=b("#themify_builder_lightbox_parent "+a+" a.selected");0===d.length&&(d=b("#themify_builder_lightbox_parent "+a+" a").first());d.trigger("click")},600)});if(d.hasClass("header-left-pane")||
d.hasClass("header-right-pane")){var u=b(".top-icon-wrap, .search-button"),v=b("#mobile-menu");b(v).prepend(b('<div class="header-icons"></div>'));b(".header-icons").append(u)}d.hasClass("header-overlay")&&b(".search-button").appendTo(".top-icon-wrap");(function(a,b){if(a.length&&b.length&&!d.is(".header-left-pane, .header-right-pane, .header-minbar-left, .header-minbar-right")){var c=a.clone();c.attr("id","cart-link-mobile");c.addClass("icon-menu");c.insertBefore(b);c.find(".tooltip").remove();if(a.is("#cart-link"))c.on("click",
function(b){b.preventDefault();a.trigger("click")})}})(b("#cart-icon-count > a"),b("#menu-icon"))});a(window).load(function(){"undefined"!==typeof ThemifyGallery&&ThemifyGallery.init({context:jQuery(themifyScript.lightboxContext)});a(function(a){a("#main-nav li").on("mouseenter mouseleave",function(b){if(a("ul",this).length){var c=a("ul:first",this);b=c.offset().left;var c=c.width(),d=a(window).width();b+c<=d?a(this).removeClass("edge"):a(this).addClass("edge")}})})}).on("load debouncedresize ready",
function(b){b=a(window).width();var c=a("body");if(c.hasClass("header-logo-center"))1183<b?(b=a(window).width()/2-a("#site-logo").width()/2,a("#main-nav").css("max-width",b)):a("#main-nav").removeAttr("style");else if(c.hasClass("header-slide-right")||c.hasClass("header-slide-left")){var c=a(".top-icon-wrap, .search-button"),e=a("#mobile-menu"),d=a("#main-nav-wrap");b>tf_mobile_menu_trigger_point?e.before(c):d.before(c)}});var e=function(){a(window).width()>tf_mobile_menu_trigger_point?a("#main-nav li.has-mega-column > ul, #main-nav li.has-mega-sub-menu > .mega-sub-menu").css("width",
a("#header").width()):a("#main-nav li.has-mega-column > ul, #main-nav li.has-mega-sub-menu > .mega-sub-menu").removeAttr("style")};a(document).on("ready",e);a(window).on("debouncedresize",e)})(jQuery);
