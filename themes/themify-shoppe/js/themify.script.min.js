...
d.hasClass("header-right-pane")){var w=b(".top-icon-wrap, .search-button"),x=b("#mobile-menu");b(x).prepend(b('<div class="header-icons"></div>'));b(".header-icons").append(w)}d.hasClass("header-overlay")&&(b(".search-button").appendTo(".top-icon-wrap"),b("#mobile-menu").wrapInner('<div class="overlay-menu-sticky"></div>'));(function(a,c){if(a.length&&c.length&&!d.is(".header-left-pane, .header-right-pane, .header-minbar-left, .header-minbar-right")){var e=a.clone(),h=b("#shopdock"),f=h.clone(),l=
...
b("#menu-icon"));if(d.hasClass("header-bottom")){jQuery("#footer").after("<a class='footer-tab' href='#'></a>");jQuery(".footer-tab").click(function(a){a.preventDefault();jQuery("#footerwrap").toggleClass("expanded")});jQuery("#footer .back-top").detach().appendTo("#pagewrap");jQuery(".back-top").addClass("back-top-float back-top-hide");var v=b(".back-top");if(0<v.length&&v.hasClass("back-top-float"))b(window).on("scroll touchstart.touchScroll touchmove.touchScroll",function(){10>window.scrollY?v.addClass("back-top-hide"):
v.removeClass("back-top-hide")})}});a(window).load(function(){function b(){var b=!0,h=c.hasClass("fixed-header");h&&c.removeClass("fixed-header");e.each(function(d){var e=a(this).data("fullwidthvideo");e&&(d={url:e,doLoop:!0,ambient:!0,id:d},b&&h&&(b=!1,d.onload=function(){c.addClass("fixed-header")}),a(this).ThemifyBgVideo(d))})}"undefined"!==typeof ThemifyGallery&&ThemifyGallery.init({context:jQuery(themifyScript.lightboxContext)});var c=a("#headerwrap"),e=c.find("[data-fullwidthvideo]");c.data("fullwidthvideo")&&
...
b+'" muted="true" autoplay="true" loop="true" playsinline="true" ><source src="'+d+'" type="video/mp4"></video></div>'),b.prependTo(a(this)))});a(function(a){a("#main-nav li").on("mouseenter mouseleave",function(b){if(a("ul",this).length){var c=a("ul:first",this);b=c.offset().left;var c=c.width(),d=a(window).width();b+c<=d?a(this).removeClass("edge"):a(this).addClass("edge")}})})}).on("load debouncedresize ready",function(b){b=a(window).width();var c=a("body");if(c.hasClass("header-logo-center"))1183<
